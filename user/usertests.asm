...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	cfa50513          	add	a0,a0,-774 # 5d38 <malloc+0xe6>
      46:	00006097          	auipc	ra,0x6
      4a:	b54080e7          	jalr	-1196(ra) # 5b9a <printf>
      exit(1);
      4e:	4505                	li	a0,1
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	64878793          	add	a5,a5,1608 # 96a0 <uninit>
      60:	0000c697          	auipc	a3,0xc
      64:	d5068693          	add	a3,a3,-688 # bdb0 <buf>
    if(uninit[i] != '\0'){
      ...
      74:	8082                	ret
{
      ...
      84:	cd850513          	add	a0,a0,-808 # 5d58 <malloc+0x106>
      88:	00006097          	auipc	ra,0x6
      8c:	b12080e7          	jalr	-1262(ra) # 5b9a <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	cc850513          	add	a0,a0,-824 # 5d70 <malloc+0x11e>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	cca50513          	add	a0,a0,-822 # 5d90 <malloc+0x13e>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	c9250513          	add	a0,a0,-878 # 5d78 <malloc+0x126>
      ee:	00006097          	auipc	ra,0x6
      f2:	aac080e7          	jalr	-1364(ra) # 5b9a <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	c9e50513          	add	a0,a0,-866 # 5da0 <malloc+0x14e>
     10a:	00006097          	auipc	ra,0x6
     10e:	a90080e7          	jalr	-1392(ra) # 5b9a <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	c9c50513          	add	a0,a0,-868 # 5dc8 <malloc+0x176>
     134:	00005097          	auipc	ra,0x5
     138:	74e080e7          	jalr	1870(ra) # 5882 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	c8850513          	add	a0,a0,-888 # 5dc8 <malloc+0x176>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	c8458593          	add	a1,a1,-892 # 5dd8 <malloc+0x186>
     15c:	00005097          	auipc	ra,0x5
     160:	6f6080e7          	jalr	1782(ra) # 5852 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	c6050513          	add	a0,a0,-928 # 5dc8 <malloc+0x176>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	c6458593          	add	a1,a1,-924 # 5de0 <malloc+0x18e>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	c3450513          	add	a0,a0,-972 # 5dc8 <malloc+0x176>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	c1e50513          	add	a0,a0,-994 # 5de8 <malloc+0x196>
     1d2:	00006097          	auipc	ra,0x6
     1d6:	9c8080e7          	jalr	-1592(ra) # 5b9a <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	b9450513          	add	a0,a0,-1132 # 5e10 <malloc+0x1be>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	b80a8a93          	add	s5,s5,-1152 # 5e10 <malloc+0x1be>
      int cc = write(fd, buf, sz);
     298:	0000ca17          	auipc	s4,0xc
     29c:	b18a0a13          	add	s4,s4,-1256 # bdb0 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2a0:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	b0e50513          	add	a0,a0,-1266 # 5e20 <malloc+0x1ce>
     31a:	00006097          	auipc	ra,0x6
     31e:	880080e7          	jalr	-1920(ra) # 5b9a <printf>
      exit(1);
     322:	4505                	li	a0,1
     ...
     338:	b0c50513          	add	a0,a0,-1268 # 5e40 <malloc+0x1ee>
     33c:	00006097          	auipc	ra,0x6
     340:	85e080e7          	jalr	-1954(ra) # 5b9a <printf>
        exit(1);
     344:	4505                	li	a0,1
...
000000000000034e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     374:	ae8a0a13          	add	s4,s4,-1304 # 5e58 <malloc+0x206>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     420:	a4450513          	add	a0,a0,-1468 # 5e60 <malloc+0x20e>
     424:	00005097          	auipc	ra,0x5
     428:	776080e7          	jalr	1910(ra) # 5b9a <printf>
      exit(1);
     42c:	4505                	li	a0,1
     ...
     43e:	a3e50513          	add	a0,a0,-1474 # 5e78 <malloc+0x226>
     442:	00005097          	auipc	ra,0x5
     446:	758080e7          	jalr	1880(ra) # 5b9a <printf>
      exit(1);
     44a:	4505                	li	a0,1
     ...
     45c:	a5050513          	add	a0,a0,-1456 # 5ea8 <malloc+0x256>
     460:	00005097          	auipc	ra,0x5
     464:	73a080e7          	jalr	1850(ra) # 5b9a <printf>
      exit(1);
     468:	4505                	li	a0,1
     ...
     476:	a6650513          	add	a0,a0,-1434 # 5ed8 <malloc+0x286>
     47a:	00005097          	auipc	ra,0x5
     47e:	720080e7          	jalr	1824(ra) # 5b9a <printf>
      exit(1);
     482:	4505                	li	a0,1
     ...
     494:	a5850513          	add	a0,a0,-1448 # 5ee8 <malloc+0x296>
     498:	00005097          	auipc	ra,0x5
     49c:	702080e7          	jalr	1794(ra) # 5b9a <printf>
      exit(1);
     4a0:	4505                	li	a0,1
...
00000000000004aa <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d2:	a4aa0a13          	add	s4,s4,-1462 # 5f18 <malloc+0x2c6>
    n = write(fds[1], "x", 1);
     4d6:	00006a97          	auipc	s5,0x6
     4da:	90aa8a93          	add	s5,s5,-1782 # 5de0 <malloc+0x18e>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     580:	9a450513          	add	a0,a0,-1628 # 5f20 <malloc+0x2ce>
     584:	00005097          	auipc	ra,0x5
     588:	616080e7          	jalr	1558(ra) # 5b9a <printf>
      exit(1);
     58c:	4505                	li	a0,1
     ...
     59e:	99e50513          	add	a0,a0,-1634 # 5f38 <malloc+0x2e6>
     5a2:	00005097          	auipc	ra,0x5
     5a6:	5f8080e7          	jalr	1528(ra) # 5b9a <printf>
      exit(1);
     5aa:	4505                	li	a0,1
     ...
     5b8:	92450513          	add	a0,a0,-1756 # 5ed8 <malloc+0x286>
     5bc:	00005097          	auipc	ra,0x5
     5c0:	5de080e7          	jalr	1502(ra) # 5b9a <printf>
      exit(1);
     5c4:	4505                	li	a0,1
     ...
     5d2:	99a50513          	add	a0,a0,-1638 # 5f68 <malloc+0x316>
     5d6:	00005097          	auipc	ra,0x5
     5da:	5c4080e7          	jalr	1476(ra) # 5b9a <printf>
      exit(1);
     5de:	4505                	li	a0,1
     ...
     5f0:	99450513          	add	a0,a0,-1644 # 5f80 <malloc+0x32e>
     5f4:	00005097          	auipc	ra,0x5
     5f8:	5a6080e7          	jalr	1446(ra) # 5b9a <printf>
      exit(1);
     5fc:	4505                	li	a0,1
...
0000000000000606 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     646:	79658593          	add	a1,a1,1942 # 5dd8 <malloc+0x186>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     662:	76a50513          	add	a0,a0,1898 # 5dc8 <malloc+0x176>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     68e:	73e50513          	add	a0,a0,1854 # 5dc8 <malloc+0x176>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a2:	72a50513          	add	a0,a0,1834 # 5dc8 <malloc+0x176>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e0:	93458593          	add	a1,a1,-1740 # 6010 <malloc+0x3be>
     6e4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     722:	6aa50513          	add	a0,a0,1706 # 5dc8 <malloc+0x176>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     766:	84e50513          	add	a0,a0,-1970 # 5fb0 <malloc+0x35e>
     76a:	00005097          	auipc	ra,0x5
     76e:	430080e7          	jalr	1072(ra) # 5b9a <printf>
    exit(1);
     772:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     782:	85250513          	add	a0,a0,-1966 # 5fd0 <malloc+0x37e>
     786:	00005097          	auipc	ra,0x5
     78a:	414080e7          	jalr	1044(ra) # 5b9a <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     78e:	8652                	mv	a2,s4
     790:	85d6                	mv	a1,s5
     792:	00006517          	auipc	a0,0x6
     796:	84e50513          	add	a0,a0,-1970 # 5fe0 <malloc+0x38e>
     79a:	00005097          	auipc	ra,0x5
     79e:	400080e7          	jalr	1024(ra) # 5b9a <printf>
    exit(1);
     7a2:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b2:	85250513          	add	a0,a0,-1966 # 6000 <malloc+0x3ae>
     7b6:	00005097          	auipc	ra,0x5
     7ba:	3e4080e7          	jalr	996(ra) # 5b9a <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7be:	8652                	mv	a2,s4
     7c0:	85d6                	mv	a1,s5
     7c2:	00006517          	auipc	a0,0x6
     7c6:	81e50513          	add	a0,a0,-2018 # 5fe0 <malloc+0x38e>
     7ca:	00005097          	auipc	ra,0x5
     7ce:	3d0080e7          	jalr	976(ra) # 5b9a <printf>
    exit(1);
     7d2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e4:	83850513          	add	a0,a0,-1992 # 6018 <malloc+0x3c6>
     7e8:	00005097          	auipc	ra,0x5
     7ec:	3b2080e7          	jalr	946(ra) # 5b9a <printf>
    exit(1);
     7f0:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     802:	83a50513          	add	a0,a0,-1990 # 6038 <malloc+0x3e6>
     806:	00005097          	auipc	ra,0x5
     80a:	394080e7          	jalr	916(ra) # 5b9a <printf>
    exit(1);
     80e:	4505                	li	a0,1
...
0000000000000818 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     836:	82650513          	add	a0,a0,-2010 # 6058 <malloc+0x406>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     84e:	83698993          	add	s3,s3,-1994 # 6080 <malloc+0x42e>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     852:	00006a97          	auipc	s5,0x6
     856:	866a8a93          	add	s5,s5,-1946 # 60b8 <malloc+0x466>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89c:	7c050513          	add	a0,a0,1984 # 6058 <malloc+0x406>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8b6:	4fe58593          	add	a1,a1,1278 # bdb0 <buf>
  ...
  if(unlink("small") < 0){
     ...
     8d8:	78450513          	add	a0,a0,1924 # 6058 <malloc+0x406>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     902:	76250513          	add	a0,a0,1890 # 6060 <malloc+0x40e>
     906:	00005097          	auipc	ra,0x5
     90a:	294080e7          	jalr	660(ra) # 5b9a <printf>
    exit(1);
     90e:	4505                	li	a0,1
     ...
     920:	77450513          	add	a0,a0,1908 # 6090 <malloc+0x43e>
     924:	00005097          	auipc	ra,0x5
     928:	276080e7          	jalr	630(ra) # 5b9a <printf>
      exit(1);
     92c:	4505                	li	a0,1
     ...
     93e:	78e50513          	add	a0,a0,1934 # 60c8 <malloc+0x476>
     942:	00005097          	auipc	ra,0x5
     946:	258080e7          	jalr	600(ra) # 5b9a <printf>
      exit(1);
     94a:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95a:	79a50513          	add	a0,a0,1946 # 60f0 <malloc+0x49e>
     95e:	00005097          	auipc	ra,0x5
     962:	23c080e7          	jalr	572(ra) # 5b9a <printf>
    exit(1);
     966:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     976:	79e50513          	add	a0,a0,1950 # 6110 <malloc+0x4be>
     97a:	00005097          	auipc	ra,0x5
     97e:	220080e7          	jalr	544(ra) # 5b9a <printf>
    exit(1);
     982:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     992:	79a50513          	add	a0,a0,1946 # 6128 <malloc+0x4d6>
     996:	00005097          	auipc	ra,0x5
     99a:	204080e7          	jalr	516(ra) # 5b9a <printf>
    exit(1);
     99e:	4505                	li	a0,1
...
00000000000009a8 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c4:	78850513          	add	a0,a0,1928 # 6148 <malloc+0x4f6>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9d8:	3dc90913          	add	s2,s2,988 # bdb0 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a16:	73650513          	add	a0,a0,1846 # 6148 <malloc+0x4f6>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a2a:	38a90913          	add	s2,s2,906 # bdb0 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a5e:	6f650513          	add	a0,a0,1782 # 6150 <malloc+0x4fe>
     a62:	00005097          	auipc	ra,0x5
     a66:	138080e7          	jalr	312(ra) # 5b9a <printf>
    exit(1);
     a6a:	4505                	li	a0,1
     ...
     a7c:	6f850513          	add	a0,a0,1784 # 6170 <malloc+0x51e>
     a80:	00005097          	auipc	ra,0x5
     a84:	11a080e7          	jalr	282(ra) # 5b9a <printf>
      exit(1);
     a88:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a98:	70450513          	add	a0,a0,1796 # 6198 <malloc+0x546>
     a9c:	00005097          	auipc	ra,0x5
     aa0:	0fe080e7          	jalr	254(ra) # 5b9a <printf>
    exit(1);
     aa4:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ac4:	68850513          	add	a0,a0,1672 # 6148 <malloc+0x4f6>
     ...
     af0:	6cc50513          	add	a0,a0,1740 # 61b8 <malloc+0x566>
     af4:	00005097          	auipc	ra,0x5
     af8:	0a6080e7          	jalr	166(ra) # 5b9a <printf>
        exit(1);
     afc:	4505                	li	a0,1
     ...
     b0e:	6d650513          	add	a0,a0,1750 # 61e0 <malloc+0x58e>
     b12:	00005097          	auipc	ra,0x5
     b16:	088080e7          	jalr	136(ra) # 5b9a <printf>
      exit(1);
     b1a:	4505                	li	a0,1
     ...
     b2c:	6d050513          	add	a0,a0,1744 # 61f8 <malloc+0x5a6>
     b30:	00005097          	auipc	ra,0x5
     b34:	06a080e7          	jalr	106(ra) # 5b9a <printf>
      exit(1);
     b38:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b48:	6dc50513          	add	a0,a0,1756 # 6220 <malloc+0x5ce>
     b4c:	00005097          	auipc	ra,0x5
     b50:	04e080e7          	jalr	78(ra) # 5b9a <printf>
    exit(1);
     b54:	4505                	li	a0,1
...
0000000000000b5e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b76:	6c650513          	add	a0,a0,1734 # 6238 <malloc+0x5e6>
  ...
  write(fd, "hello", SZ);
     ...
     b8e:	6de58593          	add	a1,a1,1758 # 6268 <malloc+0x616>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     baa:	69250513          	add	a0,a0,1682 # 6238 <malloc+0x5e6>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc0:	67c50513          	add	a0,a0,1660 # 6238 <malloc+0x5e6>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd6:	66650513          	add	a0,a0,1638 # 6238 <malloc+0x5e6>
  ...
  write(fd1, "yyy", 3);
     ...
     bea:	6ca58593          	add	a1,a1,1738 # 62b0 <malloc+0x65e>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c06:	1ae58593          	add	a1,a1,430 # bdb0 <buf>
     c0a:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c52:	5ea50513          	add	a0,a0,1514 # 6238 <malloc+0x5e6>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c72:	5da50513          	add	a0,a0,1498 # 6248 <malloc+0x5f6>
     c76:	00005097          	auipc	ra,0x5
     c7a:	f24080e7          	jalr	-220(ra) # 5b9a <printf>
    exit(1);
     c7e:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c8e:	5e650513          	add	a0,a0,1510 # 6270 <malloc+0x61e>
     c92:	00005097          	auipc	ra,0x5
     c96:	f08080e7          	jalr	-248(ra) # 5b9a <printf>
    exit(1);
     c9a:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     caa:	5ea50513          	add	a0,a0,1514 # 6290 <malloc+0x63e>
     cae:	00005097          	auipc	ra,0x5
     cb2:	eec080e7          	jalr	-276(ra) # 5b9a <printf>
    exit(1);
     cb6:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc6:	5f650513          	add	a0,a0,1526 # 62b8 <malloc+0x666>
     cca:	00005097          	auipc	ra,0x5
     cce:	ed0080e7          	jalr	-304(ra) # 5b9a <printf>
    exit(1);
     cd2:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce2:	5fa50513          	add	a0,a0,1530 # 62d8 <malloc+0x686>
     ce6:	00005097          	auipc	ra,0x5
     cea:	eb4080e7          	jalr	-332(ra) # 5b9a <printf>
    exit(1);
     cee:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     cfe:	5fe50513          	add	a0,a0,1534 # 62f8 <malloc+0x6a6>
     d02:	00005097          	auipc	ra,0x5
     d06:	e98080e7          	jalr	-360(ra) # 5b9a <printf>
    exit(1);
     d0a:	4505                	li	a0,1
...
0000000000000d14 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d62:	50a58593          	add	a1,a1,1290 # 6268 <malloc+0x616>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d82:	5a258593          	add	a1,a1,1442 # 6320 <malloc+0x6ce>
     d86:	00005517          	auipc	a0,0x5
     d8a:	59250513          	add	a0,a0,1426 # 6318 <malloc+0x6c6>
  ...
  unlink("lf1");
     ...
     d9e:	57e50513          	add	a0,a0,1406 # 6318 <malloc+0x6c6>
     da2:	00005097          	auipc	ra,0x5
     da6:	ae0080e7          	jalr	-1312(ra) # 5882 <unlink>
  if(open("lf1", 0) >= 0){
     daa:	4581                	li	a1,0
     dac:	00005517          	auipc	a0,0x5
     db0:	56c50513          	add	a0,a0,1388 # 6318 <malloc+0x6c6>
  ...
  fd = open("lf2", 0);
     ...
     dc6:	55e50513          	add	a0,a0,1374 # 6320 <malloc+0x6ce>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     dde:	fd658593          	add	a1,a1,-42 # bdb0 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     dfe:	52658593          	add	a1,a1,1318 # 6320 <malloc+0x6ce>
     e02:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e14:	51050513          	add	a0,a0,1296 # 6320 <malloc+0x6ce>
     e18:	00005097          	auipc	ra,0x5
     e1c:	a6a080e7          	jalr	-1430(ra) # 5882 <unlink>
  if(link("lf2", "lf1") >= 0){
     e20:	00005597          	auipc	a1,0x5
     e24:	4f858593          	add	a1,a1,1272 # 6318 <malloc+0x6c6>
     e28:	00005517          	auipc	a0,0x5
     e2c:	4f850513          	add	a0,a0,1272 # 6320 <malloc+0x6ce>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e40:	4dc58593          	add	a1,a1,1244 # 6318 <malloc+0x6c6>
     e44:	00005517          	auipc	a0,0x5
     e48:	5e450513          	add	a0,a0,1508 # 6428 <malloc+0x7d6>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6a:	4c250513          	add	a0,a0,1218 # 6328 <malloc+0x6d6>
     e6e:	00005097          	auipc	ra,0x5
     e72:	d2c080e7          	jalr	-724(ra) # 5b9a <printf>
    exit(1);
     e76:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e86:	4be50513          	add	a0,a0,1214 # 6340 <malloc+0x6ee>
     e8a:	00005097          	auipc	ra,0x5
     e8e:	d10080e7          	jalr	-752(ra) # 5b9a <printf>
    exit(1);
     e92:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea2:	4ba50513          	add	a0,a0,1210 # 6358 <malloc+0x706>
     ea6:	00005097          	auipc	ra,0x5
     eaa:	cf4080e7          	jalr	-780(ra) # 5b9a <printf>
    exit(1);
     eae:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ebe:	4be50513          	add	a0,a0,1214 # 6378 <malloc+0x726>
     ec2:	00005097          	auipc	ra,0x5
     ec6:	cd8080e7          	jalr	-808(ra) # 5b9a <printf>
    exit(1);
     eca:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     eda:	4d250513          	add	a0,a0,1234 # 63a8 <malloc+0x756>
     ede:	00005097          	auipc	ra,0x5
     ee2:	cbc080e7          	jalr	-836(ra) # 5b9a <printf>
    exit(1);
     ee6:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef6:	4ce50513          	add	a0,a0,1230 # 63c0 <malloc+0x76e>
     efa:	00005097          	auipc	ra,0x5
     efe:	ca0080e7          	jalr	-864(ra) # 5b9a <printf>
    exit(1);
     f02:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f12:	4ca50513          	add	a0,a0,1226 # 63d8 <malloc+0x786>
     f16:	00005097          	auipc	ra,0x5
     f1a:	c84080e7          	jalr	-892(ra) # 5b9a <printf>
    exit(1);
     f1e:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     f2e:	4d650513          	add	a0,a0,1238 # 6400 <malloc+0x7ae>
     f32:	00005097          	auipc	ra,0x5
     f36:	c68080e7          	jalr	-920(ra) # 5b9a <printf>
    exit(1);
     f3a:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4a:	4ea50513          	add	a0,a0,1258 # 6430 <malloc+0x7de>
     f4e:	00005097          	auipc	ra,0x5
     f52:	c4c080e7          	jalr	-948(ra) # 5b9a <printf>
    exit(1);
     f56:	4505                	li	a0,1
...
0000000000000f60 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb0:	4a4a0a13          	add	s4,s4,1188 # 6450 <malloc+0x7fe>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1002:	45250513          	add	a0,a0,1106 # 6450 <malloc+0x7fe>
  ...
  for(i = 0; i < N; i++){
    ...
    1072:	3ea50513          	add	a0,a0,1002 # 6458 <malloc+0x806>
    1076:	00005097          	auipc	ra,0x5
    107a:	b24080e7          	jalr	-1244(ra) # 5b9a <printf>
    exit(1);
    107e:	4505                	li	a0,1
    ...
    1092:	3ea50513          	add	a0,a0,1002 # 6478 <malloc+0x826>
    1096:	00005097          	auipc	ra,0x5
    109a:	b04080e7          	jalr	-1276(ra) # 5b9a <printf>
      exit(1);
    109e:	4505                	li	a0,1
    ...
    10ae:	3ee50513          	add	a0,a0,1006 # 6498 <malloc+0x846>
    10b2:	00005097          	auipc	ra,0x5
    10b6:	ae8080e7          	jalr	-1304(ra) # 5b9a <printf>
      exit(1);
    10ba:	4505                	li	a0,1
...
00000000000010c4 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e0:	3dc98993          	add	s3,s3,988 # 64b8 <malloc+0x866>
    10e4:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111c:	3b050513          	add	a0,a0,944 # 64c8 <malloc+0x876>
    1120:	00005097          	auipc	ra,0x5
    1124:	a7a080e7          	jalr	-1414(ra) # 5b9a <printf>
      exit(1);
    1128:	4505                	li	a0,1
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1144:	4484b483          	ld	s1,1096(s1) # 8588 <__SDATA_BEGIN__>
...
badarg(char *s)
{
    ...
    117a:	35048493          	add	s1,s1,848 # c350 <buf+0x5a0>
  for(int i = 0; i < 50000; i++){
    ...
    1188:	bec98993          	add	s3,s3,-1044 # 5d70 <malloc+0x11e>
    argv[0] = (char*)0xffffffff;
...
00000000000011b0 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1212:	4b278793          	add	a5,a5,1202 # 76c0 <malloc+0x1a6e>
  ...
  if(pid == 0){
    ...
    1248:	45478793          	add	a5,a5,1108 # 8698 <big.0>
    124c:	00008697          	auipc	a3,0x8
    1250:	44c68693          	add	a3,a3,1100 # 9698 <__global_pointer$+0x910>
      big[i] = 'x';
    ...
    1266:	42078b23          	sb	zero,1078(a5) # 9698 <__global_pointer$+0x910>
    char *args2[] = { big, big, big, 0 };
    126a:	00007797          	auipc	a5,0x7
    126e:	e9678793          	add	a5,a5,-362 # 8100 <malloc+0x24ae>
    ...
    1292:	ae250513          	add	a0,a0,-1310 # 5d70 <malloc+0x11e>
    ...
    12aa:	2ca50513          	add	a0,a0,714 # 6570 <malloc+0x91e>
    12ae:	00005097          	auipc	ra,0x5
    12b2:	8ec080e7          	jalr	-1812(ra) # 5b9a <printf>
      exit(1);
    12b6:	4505                	li	a0,1
    ...
    12ca:	22250513          	add	a0,a0,546 # 64e8 <malloc+0x896>
    12ce:	00005097          	auipc	ra,0x5
    12d2:	8cc080e7          	jalr	-1844(ra) # 5b9a <printf>
    exit(1);
    12d6:	4505                	li	a0,1
    ...
    12ea:	22250513          	add	a0,a0,546 # 6508 <malloc+0x8b6>
    12ee:	00005097          	auipc	ra,0x5
    12f2:	8ac080e7          	jalr	-1876(ra) # 5b9a <printf>
    exit(1);
    12f6:	4505                	li	a0,1
    ...
    130c:	22050513          	add	a0,a0,544 # 6528 <malloc+0x8d6>
    1310:	00005097          	auipc	ra,0x5
    1314:	88a080e7          	jalr	-1910(ra) # 5b9a <printf>
    exit(1);
    1318:	4505                	li	a0,1
    ...
    132c:	22850513          	add	a0,a0,552 # 6550 <malloc+0x8fe>
    1330:	00005097          	auipc	ra,0x5
    1334:	86a080e7          	jalr	-1942(ra) # 5b9a <printf>
    exit(1);
    1338:	4505                	li	a0,1
    ...
    1346:	6a650513          	add	a0,a0,1702 # 69e8 <malloc+0xd96>
    134a:	00005097          	auipc	ra,0x5
    134e:	850080e7          	jalr	-1968(ra) # 5b9a <printf>
    exit(1);
    1352:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1390:	20c50513          	add	a0,a0,524 # 6598 <malloc+0x946>
    1394:	00005097          	auipc	ra,0x5
    1398:	806080e7          	jalr	-2042(ra) # 5b9a <printf>
    exit(1);
    139c:	4505                	li	a0,1
...
00000000000013a6 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c2:	a0a50513          	add	a0,a0,-1526 # 5dc8 <malloc+0x176>
  ...
  if(pid == 0){
    ...
    13ec:	9e0a0a13          	add	s4,s4,-1568 # 5dc8 <malloc+0x176>
      int n = write(fd, "1234567890", 10);
    13f0:	00005a97          	auipc	s5,0x5
    13f4:	208a8a93          	add	s5,s5,520 # 65f8 <malloc+0x9a6>
      int fd = open("truncfile", O_WRONLY);
    13f8:	4585                	li	a1,1
    13fa:	8552                	mv	a0,s4
    ...
    1464:	16850513          	add	a0,a0,360 # 65c8 <malloc+0x976>
    1468:	00004097          	auipc	ra,0x4
    146c:	732080e7          	jalr	1842(ra) # 5b9a <printf>
    exit(1);
    1470:	4505                	li	a0,1
    ...
    1480:	16450513          	add	a0,a0,356 # 65e0 <malloc+0x98e>
    1484:	00004097          	auipc	ra,0x4
    1488:	716080e7          	jalr	1814(ra) # 5b9a <printf>
        exit(1);
    148c:	4505                	li	a0,1
    ...
    149e:	16e50513          	add	a0,a0,366 # 6608 <malloc+0x9b6>
    14a2:	00004097          	auipc	ra,0x4
    14a6:	6f8080e7          	jalr	1784(ra) # 5b9a <printf>
        exit(1);
    14aa:	4505                	li	a0,1
    ...
    14bc:	910a0a13          	add	s4,s4,-1776 # 5dc8 <malloc+0x176>
    int n = write(fd, "xxx", 3);
    14c0:	00005a97          	auipc	s5,0x5
    14c4:	168a8a93          	add	s5,s5,360 # 6628 <malloc+0x9d6>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    150e:	8be50513          	add	a0,a0,-1858 # 5dc8 <malloc+0x176>
  ...
  exit(xstatus);
    ...
    152c:	0b850513          	add	a0,a0,184 # 65e0 <malloc+0x98e>
    1530:	00004097          	auipc	ra,0x4
    1534:	66a080e7          	jalr	1642(ra) # 5b9a <printf>
      exit(1);
    1538:	4505                	li	a0,1
    ...
    154a:	0ea50513          	add	a0,a0,234 # 6630 <malloc+0x9de>
    154e:	00004097          	auipc	ra,0x4
    1552:	64c080e7          	jalr	1612(ra) # 5b9a <printf>
      exit(1);
    1556:	4505                	li	a0,1
...
0000000000001560 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1572:	80278793          	add	a5,a5,-2046 # 5d70 <malloc+0x11e>
    1576:	fcf43023          	sd	a5,-64(s0)
    157a:	00005797          	auipc	a5,0x5
    157e:	0d678793          	add	a5,a5,214 # 6650 <malloc+0x9fe>
    1582:	fcf43423          	sd	a5,-56(s0)
    1586:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    158a:	00005517          	auipc	a0,0x5
    158e:	0ce50513          	add	a0,a0,206 # 6658 <malloc+0xa06>
  ...
  if(pid == 0) {
    ...
    15bc:	0a050513          	add	a0,a0,160 # 6658 <malloc+0xa06>
    ...
    15d8:	0a450513          	add	a0,a0,164 # 6678 <malloc+0xa26>
    15dc:	00004097          	auipc	ra,0x4
    15e0:	5be080e7          	jalr	1470(ra) # 5b9a <printf>
      exit(1);
    15e4:	4505                	li	a0,1
    ...
    15f4:	fd850513          	add	a0,a0,-40 # 65c8 <malloc+0x976>
    15f8:	00004097          	auipc	ra,0x4
    15fc:	5a2080e7          	jalr	1442(ra) # 5b9a <printf>
     exit(1);
    1600:	4505                	li	a0,1
    ...
    1610:	05450513          	add	a0,a0,84 # 6660 <malloc+0xa0e>
    1614:	00004097          	auipc	ra,0x4
    1618:	586080e7          	jalr	1414(ra) # 5b9a <printf>
      exit(1);
    161c:	4505                	li	a0,1
    ...
    162e:	74650513          	add	a0,a0,1862 # 5d70 <malloc+0x11e>
  ...
  if(xstatus != 0)
    ...
    1662:	02a50513          	add	a0,a0,42 # 6688 <malloc+0xa36>
    1666:	00004097          	auipc	ra,0x4
    166a:	534080e7          	jalr	1332(ra) # 5b9a <printf>
      exit(1);
    166e:	4505                	li	a0,1
    ...
    167e:	02650513          	add	a0,a0,38 # 66a0 <malloc+0xa4e>
    1682:	00004097          	auipc	ra,0x4
    1686:	518080e7          	jalr	1304(ra) # 5b9a <printf>
    168a:	b7d1                	j	164e <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    168c:	4581                	li	a1,0
    168e:	00005517          	auipc	a0,0x5
    1692:	fca50513          	add	a0,a0,-54 # 6658 <malloc+0xa06>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16bc:	a5850513          	add	a0,a0,-1448 # 6110 <malloc+0x4be>
    16c0:	00004097          	auipc	ra,0x4
    16c4:	4da080e7          	jalr	1242(ra) # 5b9a <printf>
    exit(1);
    16c8:	4505                	li	a0,1
    ...
    16d8:	f0c50513          	add	a0,a0,-244 # 65e0 <malloc+0x98e>
    16dc:	00004097          	auipc	ra,0x4
    16e0:	4be080e7          	jalr	1214(ra) # 5b9a <printf>
    exit(1);
    16e4:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    16f2:	f6a50513          	add	a0,a0,-150 # 6658 <malloc+0xa06>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    171c:	fa050513          	add	a0,a0,-96 # 66b8 <malloc+0xa66>
    1720:	00004097          	auipc	ra,0x4
    1724:	47a080e7          	jalr	1146(ra) # 5b9a <printf>
    exit(1);
    1728:	4505                	li	a0,1
...
000000000000173c <pipe1>:
{
  ...
  if(pid == 0){
    ...
    1788:	62ca8a93          	add	s5,s5,1580 # bdb0 <buf>
    178c:	864e                	mv	a2,s3
    178e:	85d6                	mv	a1,s5
    ...
    17a4:	61070713          	add	a4,a4,1552 # bdb0 <buf>
    ...
    17dc:	ef850513          	add	a0,a0,-264 # 66d0 <malloc+0xa7e>
    17e0:	00004097          	auipc	ra,0x4
    17e4:	3ba080e7          	jalr	954(ra) # 5b9a <printf>
    exit(1);
    17e8:	4505                	li	a0,1
    ...
    1802:	5b2b0b13          	add	s6,s6,1458 # bdb0 <buf>
    ...
    1816:	42da8a93          	add	s5,s5,1069 # 142d <truncate3+0x87>
{
    ...
    1862:	e8a50513          	add	a0,a0,-374 # 66e8 <malloc+0xa96>
    1866:	00004097          	auipc	ra,0x4
    186a:	334080e7          	jalr	820(ra) # 5b9a <printf>
        exit(1);
    186e:	4505                	li	a0,1
    ...
    187e:	e8650513          	add	a0,a0,-378 # 6700 <malloc+0xaae>
    1882:	00004097          	auipc	ra,0x4
    1886:	318080e7          	jalr	792(ra) # 5b9a <printf>
}
    ...
    18b0:	e6c50513          	add	a0,a0,-404 # 6718 <malloc+0xac6>
    18b4:	00004097          	auipc	ra,0x4
    18b8:	2e6080e7          	jalr	742(ra) # 5b9a <printf>
      exit(1);
    18bc:	4505                	li	a0,1
    ...
    18f0:	e4c50513          	add	a0,a0,-436 # 6738 <malloc+0xae6>
    18f4:	00004097          	auipc	ra,0x4
    18f8:	2a6080e7          	jalr	678(ra) # 5b9a <printf>
    exit(1);
    18fc:	4505                	li	a0,1
...
0000000000001906 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1962:	c6a50513          	add	a0,a0,-918 # 65c8 <malloc+0x976>
    1966:	00004097          	auipc	ra,0x4
    196a:	234080e7          	jalr	564(ra) # 5b9a <printf>
      exit(1);
    196e:	4505                	li	a0,1
    ...
    197e:	dd650513          	add	a0,a0,-554 # 6750 <malloc+0xafe>
    1982:	00004097          	auipc	ra,0x4
    1986:	218080e7          	jalr	536(ra) # 5b9a <printf>
        exit(1);
    198a:	4505                	li	a0,1
    ...
    199a:	dd250513          	add	a0,a0,-558 # 6768 <malloc+0xb16>
    199e:	00004097          	auipc	ra,0x4
    19a2:	1fc080e7          	jalr	508(ra) # 5b9a <printf>
        exit(1);
    19a6:	4505                	li	a0,1
...
00000000000019ba <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a12:	bba50513          	add	a0,a0,-1094 # 65c8 <malloc+0x976>
    1a16:	00004097          	auipc	ra,0x4
    1a1a:	184080e7          	jalr	388(ra) # 5b9a <printf>
      exit(1);
    1a1e:	4505                	li	a0,1
    ...
    1a36:	b9650513          	add	a0,a0,-1130 # 65c8 <malloc+0x976>
    1a3a:	00004097          	auipc	ra,0x4
    1a3e:	160080e7          	jalr	352(ra) # 5b9a <printf>
        exit(1);
    1a42:	4505                	li	a0,1
...
0000000000001a54 <forkfork>:
{
    ...
    1ab0:	cdc50513          	add	a0,a0,-804 # 6788 <malloc+0xb36>
    1ab4:	00004097          	auipc	ra,0x4
    1ab8:	0e6080e7          	jalr	230(ra) # 5b9a <printf>
      exit(1);
    1abc:	4505                	li	a0,1
    ...
    1ac2:	d74080e7          	jalr	-652(ra) # 5832 <exit>
{
    ...
    1b08:	c9450513          	add	a0,a0,-876 # 6798 <malloc+0xb46>
    1b0c:	00004097          	auipc	ra,0x4
    1b10:	08e080e7          	jalr	142(ra) # 5b9a <printf>
      exit(1);
    1b14:	4505                	li	a0,1
...
0000000000001b1e <reparent2>:
{
  ...
  exit(0);
    ...
    1b56:	e9650513          	add	a0,a0,-362 # 69e8 <malloc+0xd96>
    1b5a:	00004097          	auipc	ra,0x4
    1b5e:	040080e7          	jalr	64(ra) # 5b9a <printf>
      exit(1);
    1b62:	4505                	li	a0,1
...
0000000000001b86 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bf4:	df850513          	add	a0,a0,-520 # 69e8 <malloc+0xd96>
    1bf8:	00004097          	auipc	ra,0x4
    1bfc:	fa2080e7          	jalr	-94(ra) # 5b9a <printf>
      exit(1);
    1c00:	4505                	li	a0,1
    ...
    1c20:	a4450513          	add	a0,a0,-1468 # 6660 <malloc+0xa0e>
    1c24:	00004097          	auipc	ra,0x4
    1c28:	f76080e7          	jalr	-138(ra) # 5b9a <printf>
          exit(1);
    1c2c:	4505                	li	a0,1
    ...
    1c92:	b2a50513          	add	a0,a0,-1238 # 67b8 <malloc+0xb66>
    1c96:	00004097          	auipc	ra,0x4
    1c9a:	f04080e7          	jalr	-252(ra) # 5b9a <printf>
            exit(1);
    1c9e:	4505                	li	a0,1
    ...
    1cc6:	b0e50513          	add	a0,a0,-1266 # 67d0 <malloc+0xb7e>
    1cca:	00004097          	auipc	ra,0x4
    1cce:	ed0080e7          	jalr	-304(ra) # 5b9a <printf>
        exit(1);
    1cd2:	4505                	li	a0,1
    ...
    1d2c:	ad050513          	add	a0,a0,-1328 # 67f8 <malloc+0xba6>
    1d30:	00004097          	auipc	ra,0x4
    1d34:	e6a080e7          	jalr	-406(ra) # 5b9a <printf>
        exit(1);
    1d38:	4505                	li	a0,1
...
0000000000001dac <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dcc:	01850513          	add	a0,a0,24 # 5de0 <malloc+0x18e>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1df6:	e6d9899b          	addw	s3,s3,-403 # 41c64e6d <__BSS_END__+0x41c560ad>
    ...
    1e08:	fdca8a93          	add	s5,s5,-36 # 5de0 <malloc+0x18e>
      link("cat", "x");
    1e0c:	00005b97          	auipc	s7,0x5
    1e10:	a14b8b93          	add	s7,s7,-1516 # 6820 <malloc+0xbce>
    1e14:	a825                	j	1e4c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1e16:	85a6                	mv	a1,s1
    1e18:	00004517          	auipc	a0,0x4
    1e1c:	7b050513          	add	a0,a0,1968 # 65c8 <malloc+0x976>
    1e20:	00004097          	auipc	ra,0x4
    1e24:	d7a080e7          	jalr	-646(ra) # 5b9a <printf>
    exit(1);
    1e28:	4505                	li	a0,1
...
0000000000001eae <manywrites>:
{
  ...
  exit(0);
    ...
    1f0a:	ae250513          	add	a0,a0,-1310 # 69e8 <malloc+0xd96>
    1f0e:	00004097          	auipc	ra,0x4
    1f12:	c8c080e7          	jalr	-884(ra) # 5b9a <printf>
      exit(1);
    1f16:	4505                	li	a0,1
    ...
    1f46:	e6eb0b13          	add	s6,s6,-402 # bdb0 <buf>
    ...
    1fba:	87250513          	add	a0,a0,-1934 # 6828 <malloc+0xbd6>
    1fbe:	00004097          	auipc	ra,0x4
    1fc2:	bdc080e7          	jalr	-1060(ra) # 5b9a <printf>
            exit(1);
    1fc6:	4505                	li	a0,1
    ...
    1fda:	e6a50513          	add	a0,a0,-406 # 5e40 <malloc+0x1ee>
    1fde:	00004097          	auipc	ra,0x4
    1fe2:	bbc080e7          	jalr	-1092(ra) # 5b9a <printf>
            exit(1);
    1fe6:	4505                	li	a0,1
...
0000000000001ff8 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    2028:	83450513          	add	a0,a0,-1996 # 6858 <malloc+0xc06>
    202c:	00004097          	auipc	ra,0x4
    2030:	b6e080e7          	jalr	-1170(ra) # 5b9a <printf>
    exit(1);
    2034:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    208a:	7ba50513          	add	a0,a0,1978 # 6840 <malloc+0xbee>
    208e:	00004097          	auipc	ra,0x4
    2092:	b0c080e7          	jalr	-1268(ra) # 5b9a <printf>
    exit(1);
    2096:	4505                	li	a0,1
    ...
    20a6:	7de50513          	add	a0,a0,2014 # 6880 <malloc+0xc2e>
    20aa:	00004097          	auipc	ra,0x4
    20ae:	af0080e7          	jalr	-1296(ra) # 5b9a <printf>
      exit(1);
    20b2:	4505                	li	a0,1
    ...
    20c2:	7da50513          	add	a0,a0,2010 # 6898 <malloc+0xc46>
    20c6:	00004097          	auipc	ra,0x4
    20ca:	ad4080e7          	jalr	-1324(ra) # 5b9a <printf>
    exit(1);
    20ce:	4505                	li	a0,1
...
00000000000020d8 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    20f4:	35098993          	add	s3,s3,848 # c350 <buf+0x5a0>
    20f8:	1003d937          	lui	s2,0x1003d
    20fc:	090e                	sll	s2,s2,0x3
    20fe:	48090913          	add	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e6c0>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2142:	48a50513          	add	a0,a0,1162 # 65c8 <malloc+0x976>
    2146:	00004097          	auipc	ra,0x4
    214a:	a54080e7          	jalr	-1452(ra) # 5b9a <printf>
      exit(1);
    214e:	4505                	li	a0,1
    ...
    2164:	75050513          	add	a0,a0,1872 # 68b0 <malloc+0xc5e>
    2168:	00004097          	auipc	ra,0x4
    216c:	a32080e7          	jalr	-1486(ra) # 5b9a <printf>
      exit(1);
    2170:	4505                	li	a0,1
...
0000000000002184 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    21e6:	3e650513          	add	a0,a0,998 # 65c8 <malloc+0x976>
    21ea:	00004097          	auipc	ra,0x4
    21ee:	9b0080e7          	jalr	-1616(ra) # 5b9a <printf>
      exit(1);
    21f2:	4505                	li	a0,1
    ...
    2212:	6c250513          	add	a0,a0,1730 # 68d0 <malloc+0xc7e>
    2216:	00004097          	auipc	ra,0x4
    221a:	984080e7          	jalr	-1660(ra) # 5b9a <printf>
      exit(1);
    221e:	4505                	li	a0,1
...
0000000000002232 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2242:	6aa50513          	add	a0,a0,1706 # 68e8 <malloc+0xc96>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2274:	67850513          	add	a0,a0,1656 # 68e8 <malloc+0xc96>
  ...
  close(fd);
    ...
    229a:	30278793          	add	a5,a5,770 # 8598 <args.1>
    229e:	00006697          	auipc	a3,0x6
    22a2:	3f268693          	add	a3,a3,1010 # 8690 <args.1+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    22a6:	00004717          	auipc	a4,0x4
    22aa:	65270713          	add	a4,a4,1618 # 68f8 <malloc+0xca6>
    ...
    22fe:	6de50513          	add	a0,a0,1758 # 69d8 <malloc+0xd86>
    2302:	00004097          	auipc	ra,0x4
    2306:	898080e7          	jalr	-1896(ra) # 5b9a <printf>
    exit(1);
    230a:	4505                	li	a0,1
    ...
    2322:	6da50513          	add	a0,a0,1754 # 69f8 <malloc+0xda6>
    2326:	00004097          	auipc	ra,0x4
    232a:	874080e7          	jalr	-1932(ra) # 5b9a <printf>
    exit(1);
    232e:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2376:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff0240>
    237a:	85a6                	mv	a1,s1
    237c:	00004517          	auipc	a0,0x4
    2380:	69c50513          	add	a0,a0,1692 # 6a18 <malloc+0xdc6>
    2384:	00004097          	auipc	ra,0x4
    2388:	816080e7          	jalr	-2026(ra) # 5b9a <printf>
    exit(1);
    238c:	4505                	li	a0,1
    ...
    239c:	23050513          	add	a0,a0,560 # 65c8 <malloc+0x976>
    23a0:	00003097          	auipc	ra,0x3
    23a4:	7fa080e7          	jalr	2042(ra) # 5b9a <printf>
    exit(1);
    23a8:	4505                	li	a0,1
...
00000000000023bc <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2436:	28e78793          	add	a5,a5,654 # 76c0 <malloc+0x1a6e>
  ...
  if(ret != -1){
    ...
    2478:	5cc50513          	add	a0,a0,1484 # 6a40 <malloc+0xdee>
    247c:	00003097          	auipc	ra,0x3
    2480:	71e080e7          	jalr	1822(ra) # 5b9a <printf>
    exit(1);
    2484:	4505                	li	a0,1
    ...
    2496:	05650513          	add	a0,a0,86 # 64e8 <malloc+0x896>
    249a:	00003097          	auipc	ra,0x3
    249e:	700080e7          	jalr	1792(ra) # 5b9a <printf>
    exit(1);
    24a2:	4505                	li	a0,1
    ...
    24b4:	05850513          	add	a0,a0,88 # 6508 <malloc+0x8b6>
    24b8:	00003097          	auipc	ra,0x3
    24bc:	6e2080e7          	jalr	1762(ra) # 5b9a <printf>
    exit(1);
    24c0:	4505                	li	a0,1
    ...
    24d4:	05850513          	add	a0,a0,88 # 6528 <malloc+0x8d6>
    24d8:	00003097          	auipc	ra,0x3
    24dc:	6c2080e7          	jalr	1730(ra) # 5b9a <printf>
    exit(1);
    24e0:	4505                	li	a0,1
    ...
    24f2:	06250513          	add	a0,a0,98 # 6550 <malloc+0x8fe>
    24f6:	00003097          	auipc	ra,0x3
    24fa:	6a4080e7          	jalr	1700(ra) # 5b9a <printf>
    exit(1);
    24fe:	4505                	li	a0,1
...
0000000000002508 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    253e:	54650513          	add	a0,a0,1350 # 6a80 <malloc+0xe2e>
  ...
  if(n >= 0){
    ...
    256e:	53650513          	add	a0,a0,1334 # 6aa0 <malloc+0xe4e>
    2572:	00003097          	auipc	ra,0x3
    2576:	628080e7          	jalr	1576(ra) # 5b9a <printf>
    exit(1);
    257a:	4505                	li	a0,1
    ...
    2588:	4c450513          	add	a0,a0,1220 # 6a48 <malloc+0xdf6>
    258c:	00003097          	auipc	ra,0x3
    2590:	60e080e7          	jalr	1550(ra) # 5b9a <printf>
    exit(1);
    2594:	4505                	li	a0,1
    ...
    25a2:	4c250513          	add	a0,a0,1218 # 6a60 <malloc+0xe0e>
    25a6:	00003097          	auipc	ra,0x3
    25aa:	5f4080e7          	jalr	1524(ra) # 5b9a <printf>
    exit(1);
    25ae:	4505                	li	a0,1
    ...
    25bc:	4d050513          	add	a0,a0,1232 # 6a88 <malloc+0xe36>
    25c0:	00003097          	auipc	ra,0x3
    25c4:	5da080e7          	jalr	1498(ra) # 5b9a <printf>
    exit(1);
    25c8:	4505                	li	a0,1
  ...
  if(n >= 0){
    ...
    261c:	4b850513          	add	a0,a0,1208 # 6ad0 <malloc+0xe7e>
    2620:	00003097          	auipc	ra,0x3
    2624:	57a080e7          	jalr	1402(ra) # 5b9a <printf>
    exit(1);
    2628:	4505                	li	a0,1
    ...
    2636:	45650513          	add	a0,a0,1110 # 6a88 <malloc+0xe36>
    263a:	00003097          	auipc	ra,0x3
    263e:	560080e7          	jalr	1376(ra) # 5b9a <printf>
    exit(1);
    2642:	4505                	li	a0,1
...
0000000000002660 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    269c:	6705                	lui	a4,0x1
      *b = 99;
    269e:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff1240>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    26b6:	44650513          	add	a0,a0,1094 # 6af8 <malloc+0xea6>
    26ba:	00003097          	auipc	ra,0x3
    26be:	4e0080e7          	jalr	1248(ra) # 5b9a <printf>
    exit(1);
    26c2:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2708:	41450513          	add	a0,a0,1044 # 6b18 <malloc+0xec6>
    270c:	00003097          	auipc	ra,0x3
    2710:	48e080e7          	jalr	1166(ra) # 5b9a <printf>
    exit(1);
    2714:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    276c:	41050513          	add	a0,a0,1040 # 6b78 <malloc+0xf26>
    2770:	00003097          	auipc	ra,0x3
    2774:	42a080e7          	jalr	1066(ra) # 5b9a <printf>
    exit(1);
    2778:	4505                	li	a0,1
    ...
    278e:	3ae50513          	add	a0,a0,942 # 6b38 <malloc+0xee6>
    2792:	00003097          	auipc	ra,0x3
    2796:	408080e7          	jalr	1032(ra) # 5b9a <printf>
      exit(1);
    279a:	4505                	li	a0,1
    ...
    27aa:	3b250513          	add	a0,a0,946 # 6b58 <malloc+0xf06>
    27ae:	00003097          	auipc	ra,0x3
    27b2:	3ec080e7          	jalr	1004(ra) # 5b9a <printf>
    exit(1);
    27b6:	4505                	li	a0,1
...
00000000000027e6 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    2848:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f123f>
  a = sbrk(0);
    284c:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    28ac:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f123f>
  ...
  if(c != a){
    ...
    28f4:	2a850513          	add	a0,a0,680 # 6b98 <malloc+0xf46>
    28f8:	00003097          	auipc	ra,0x3
    28fc:	2a2080e7          	jalr	674(ra) # 5b9a <printf>
    exit(1);
    2900:	4505                	li	a0,1
    ...
    2910:	2d450513          	add	a0,a0,724 # 6be0 <malloc+0xf8e>
    2914:	00003097          	auipc	ra,0x3
    2918:	286080e7          	jalr	646(ra) # 5b9a <printf>
    exit(1);
    291c:	4505                	li	a0,1
    ...
    2930:	2d450513          	add	a0,a0,724 # 6c00 <malloc+0xfae>
    2934:	00003097          	auipc	ra,0x3
    2938:	266080e7          	jalr	614(ra) # 5b9a <printf>
    exit(1);
    293c:	4505                	li	a0,1
    ...
    2950:	2f450513          	add	a0,a0,756 # 6c40 <malloc+0xfee>
    2954:	00003097          	auipc	ra,0x3
    2958:	246080e7          	jalr	582(ra) # 5b9a <printf>
    exit(1);
    295c:	4505                	li	a0,1
    ...
    296c:	30850513          	add	a0,a0,776 # 6c70 <malloc+0x101e>
    2970:	00003097          	auipc	ra,0x3
    2974:	22a080e7          	jalr	554(ra) # 5b9a <printf>
    exit(1);
    2978:	4505                	li	a0,1
    ...
    298c:	32050513          	add	a0,a0,800 # 6ca8 <malloc+0x1056>
    2990:	00003097          	auipc	ra,0x3
    2994:	20a080e7          	jalr	522(ra) # 5b9a <printf>
    exit(1);
    2998:	4505                	li	a0,1
...
00000000000029a2 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    29c6:	30e50513          	add	a0,a0,782 # 6cd0 <malloc+0x107e>
    29ca:	00003097          	auipc	ra,0x3
    29ce:	ea8080e7          	jalr	-344(ra) # 5872 <open>
    29d2:	84aa                	mv	s1,a0
  unlink("sbrk");
    29d4:	00004517          	auipc	a0,0x4
    29d8:	2fc50513          	add	a0,a0,764 # 6cd0 <malloc+0x107e>
  ...
  if(pipe((int *) a) != 0){
    ...
    2a2c:	2b050513          	add	a0,a0,688 # 6cd8 <malloc+0x1086>
    2a30:	00003097          	auipc	ra,0x3
    2a34:	16a080e7          	jalr	362(ra) # 5b9a <printf>
    exit(1);
    2a38:	4505                	li	a0,1
    ...
    2a48:	2ac50513          	add	a0,a0,684 # 6cf0 <malloc+0x109e>
    2a4c:	00003097          	auipc	ra,0x3
    2a50:	14e080e7          	jalr	334(ra) # 5b9a <printf>
    exit(1);
    2a54:	4505                	li	a0,1
    ...
    2a64:	c7050513          	add	a0,a0,-912 # 66d0 <malloc+0xa7e>
    2a68:	00003097          	auipc	ra,0x3
    2a6c:	132080e7          	jalr	306(ra) # 5b9a <printf>
    exit(1);
    2a70:	4505                	li	a0,1
...
0000000000002a7a <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2a8e:	27e50513          	add	a0,a0,638 # 6d08 <malloc+0x10b6>
  ...
  close(fd);
    ...
    2ad6:	b0e50513          	add	a0,a0,-1266 # 65e0 <malloc+0x98e>
    2ada:	00003097          	auipc	ra,0x3
    2ade:	0c0080e7          	jalr	192(ra) # 5b9a <printf>
    exit(1);
    2ae2:	4505                	li	a0,1
...
0000000000002aec <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2b24:	ec850513          	add	a0,a0,-312 # 69e8 <malloc+0xd96>
    2b28:	00003097          	auipc	ra,0x3
    2b2c:	072080e7          	jalr	114(ra) # 5b9a <printf>
    exit(1);
    2b30:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2b7a:	e7250513          	add	a0,a0,-398 # 69e8 <malloc+0xd96>
    2b7e:	00003097          	auipc	ra,0x3
    2b82:	01c080e7          	jalr	28(ra) # 5b9a <printf>
    exit(1);
    2b86:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2bb2:	8007879b          	addw	a5,a5,-2048 # a800 <uninit+0x1160>
    ...
    2bda:	e1250513          	add	a0,a0,-494 # 69e8 <malloc+0xd96>
    2bde:	00003097          	auipc	ra,0x3
    2be2:	fbc080e7          	jalr	-68(ra) # 5b9a <printf>
    exit(1);
    2be6:	4505                	li	a0,1
...
0000000000002cd6 <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    2ce2:	0511                	add	a0,a0,4 # ffffffff80000004 <__BSS_END__+0xffffffff7fff1244>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2d4e:	c9e50513          	add	a0,a0,-866 # 69e8 <malloc+0xd96>
    2d52:	00003097          	auipc	ra,0x3
    2d56:	e48080e7          	jalr	-440(ra) # 5b9a <printf>
      exit(1);
    2d5a:	4505                	li	a0,1
    ...
    2da2:	fd250513          	add	a0,a0,-46 # 5d70 <malloc+0x11e>
    2da6:	faa43c23          	sd	a0,-72(s0)
    2daa:	00003797          	auipc	a5,0x3
    2dae:	03678793          	add	a5,a5,54 # 5de0 <malloc+0x18e>
...
0000000000002dd0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2de0:	10450513          	add	a0,a0,260 # 6ee0 <malloc+0x128e>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2df2:	f4a50513          	add	a0,a0,-182 # 6d38 <malloc+0x10e6>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2e08:	f8c50513          	add	a0,a0,-116 # 6d90 <malloc+0x113e>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2e26:	fe650513          	add	a0,a0,-26 # 6e08 <malloc+0x11b6>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2e42:	03a50513          	add	a0,a0,58 # 6e78 <malloc+0x1226>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2e54:	08050513          	add	a0,a0,128 # 6ed0 <malloc+0x127e>
  ...
  unlink("12345678901234");
    ...
    2ed2:	e4250513          	add	a0,a0,-446 # 6d10 <malloc+0x10be>
    2ed6:	00003097          	auipc	ra,0x3
    2eda:	cc4080e7          	jalr	-828(ra) # 5b9a <printf>
    exit(1);
    2ede:	4505                	li	a0,1
    ...
    2eee:	e6e50513          	add	a0,a0,-402 # 6d58 <malloc+0x1106>
    2ef2:	00003097          	auipc	ra,0x3
    2ef6:	ca8080e7          	jalr	-856(ra) # 5b9a <printf>
    exit(1);
    2efa:	4505                	li	a0,1
    ...
    2f0a:	eba50513          	add	a0,a0,-326 # 6dc0 <malloc+0x116e>
    2f0e:	00003097          	auipc	ra,0x3
    2f12:	c8c080e7          	jalr	-884(ra) # 5b9a <printf>
    exit(1);
    2f16:	4505                	li	a0,1
    ...
    2f26:	f1650513          	add	a0,a0,-234 # 6e38 <malloc+0x11e6>
    2f2a:	00003097          	auipc	ra,0x3
    2f2e:	c70080e7          	jalr	-912(ra) # 5b9a <printf>
    exit(1);
    2f32:	4505                	li	a0,1
    ...
    2f42:	f5a50513          	add	a0,a0,-166 # 6e98 <malloc+0x1246>
    2f46:	00003097          	auipc	ra,0x3
    2f4a:	c54080e7          	jalr	-940(ra) # 5b9a <printf>
    exit(1);
    2f4e:	4505                	li	a0,1
    ...
    2f5e:	f9650513          	add	a0,a0,-106 # 6ef0 <malloc+0x129e>
    2f62:	00003097          	auipc	ra,0x3
    2f66:	c38080e7          	jalr	-968(ra) # 5b9a <printf>
    exit(1);
    2f6a:	4505                	li	a0,1
...
0000000000002f74 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2f84:	fa850513          	add	a0,a0,-88 # 6f28 <malloc+0x12d6>
  ...
  if(chdir("iputdir") < 0){
    ...
    2f98:	f9450513          	add	a0,a0,-108 # 6f28 <malloc+0x12d6>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2fac:	fc050513          	add	a0,a0,-64 # 6f68 <malloc+0x1316>
  ...
  if(chdir("/") < 0){
    ...
    2fc0:	fdc50513          	add	a0,a0,-36 # 6f98 <malloc+0x1346>
    ...
    2fe0:	f5450513          	add	a0,a0,-172 # 6f30 <malloc+0x12de>
    2fe4:	00003097          	auipc	ra,0x3
    2fe8:	bb6080e7          	jalr	-1098(ra) # 5b9a <printf>
    exit(1);
    2fec:	4505                	li	a0,1
    ...
    2ffc:	f5050513          	add	a0,a0,-176 # 6f48 <malloc+0x12f6>
    3000:	00003097          	auipc	ra,0x3
    3004:	b9a080e7          	jalr	-1126(ra) # 5b9a <printf>
    exit(1);
    3008:	4505                	li	a0,1
    ...
    3018:	f6450513          	add	a0,a0,-156 # 6f78 <malloc+0x1326>
    301c:	00003097          	auipc	ra,0x3
    3020:	b7e080e7          	jalr	-1154(ra) # 5b9a <printf>
    exit(1);
    3024:	4505                	li	a0,1
    ...
    3034:	f7050513          	add	a0,a0,-144 # 6fa0 <malloc+0x134e>
    3038:	00003097          	auipc	ra,0x3
    303c:	b62080e7          	jalr	-1182(ra) # 5b9a <printf>
    exit(1);
    3040:	4505                	li	a0,1
...
000000000000304a <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    3068:	ec450513          	add	a0,a0,-316 # 6f28 <malloc+0x12d6>
    ...
    307c:	eb050513          	add	a0,a0,-336 # 6f28 <malloc+0x12d6>
    ...
    3090:	edc50513          	add	a0,a0,-292 # 6f68 <malloc+0x1316>
    ...
    30b0:	51c50513          	add	a0,a0,1308 # 65c8 <malloc+0x976>
    30b4:	00003097          	auipc	ra,0x3
    30b8:	ae6080e7          	jalr	-1306(ra) # 5b9a <printf>
    exit(1);
    30bc:	4505                	li	a0,1
    ...
    30cc:	e6850513          	add	a0,a0,-408 # 6f30 <malloc+0x12de>
    30d0:	00003097          	auipc	ra,0x3
    30d4:	aca080e7          	jalr	-1334(ra) # 5b9a <printf>
      exit(1);
    30d8:	4505                	li	a0,1
    ...
    30e8:	ed450513          	add	a0,a0,-300 # 6fb8 <malloc+0x1366>
    30ec:	00003097          	auipc	ra,0x3
    30f0:	aae080e7          	jalr	-1362(ra) # 5b9a <printf>
      exit(1);
    30f4:	4505                	li	a0,1
    ...
    3104:	e7850513          	add	a0,a0,-392 # 6f78 <malloc+0x1326>
    3108:	00003097          	auipc	ra,0x3
    310c:	a92080e7          	jalr	-1390(ra) # 5b9a <printf>
      exit(1);
    3110:	4505                	li	a0,1
...
0000000000003132 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    3142:	e9250513          	add	a0,a0,-366 # 6fd0 <malloc+0x137e>
  ...
  if(chdir("dir0") < 0){
    ...
    3156:	e7e50513          	add	a0,a0,-386 # 6fd0 <malloc+0x137e>
  ...
  if(chdir("..") < 0){
    ...
    316a:	e8a50513          	add	a0,a0,-374 # 6ff0 <malloc+0x139e>
  ...
  if(unlink("dir0") < 0){
    ...
    317e:	e5650513          	add	a0,a0,-426 # 6fd0 <malloc+0x137e>
    ...
    319e:	d9650513          	add	a0,a0,-618 # 6f30 <malloc+0x12de>
    31a2:	00003097          	auipc	ra,0x3
    31a6:	9f8080e7          	jalr	-1544(ra) # 5b9a <printf>
    exit(1);
    31aa:	4505                	li	a0,1
    ...
    31ba:	e2250513          	add	a0,a0,-478 # 6fd8 <malloc+0x1386>
    31be:	00003097          	auipc	ra,0x3
    31c2:	9dc080e7          	jalr	-1572(ra) # 5b9a <printf>
    exit(1);
    31c6:	4505                	li	a0,1
    ...
    31d6:	e2650513          	add	a0,a0,-474 # 6ff8 <malloc+0x13a6>
    31da:	00003097          	auipc	ra,0x3
    31de:	9c0080e7          	jalr	-1600(ra) # 5b9a <printf>
    exit(1);
    31e2:	4505                	li	a0,1
    ...
    31f2:	e2250513          	add	a0,a0,-478 # 7010 <malloc+0x13be>
    31f6:	00003097          	auipc	ra,0x3
    31fa:	9a4080e7          	jalr	-1628(ra) # 5b9a <printf>
    exit(1);
    31fe:	4505                	li	a0,1
...
0000000000003208 <subdir>:
{
  ...
  unlink("ff");
    ...
    321a:	f4250513          	add	a0,a0,-190 # 7158 <malloc+0x1506>
    321e:	00002097          	auipc	ra,0x2
    3222:	664080e7          	jalr	1636(ra) # 5882 <unlink>
  if(mkdir("dd") != 0){
    3226:	00004517          	auipc	a0,0x4
    322a:	e0250513          	add	a0,a0,-510 # 7028 <malloc+0x13d6>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3242:	e0a50513          	add	a0,a0,-502 # 7048 <malloc+0x13f6>
  ...
  write(fd, "ff", 2);
    ...
    325a:	f0258593          	add	a1,a1,-254 # 7158 <malloc+0x1506>
  ...
  if(unlink("dd") >= 0){
    ...
    3274:	db850513          	add	a0,a0,-584 # 7028 <malloc+0x13d6>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3288:	e1c50513          	add	a0,a0,-484 # 70a0 <malloc+0x144e>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32a0:	e2c50513          	add	a0,a0,-468 # 70c8 <malloc+0x1476>
  ...
  write(fd, "FF", 2);
    ...
    32b8:	e4458593          	add	a1,a1,-444 # 70f8 <malloc+0x14a6>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    32d4:	e3050513          	add	a0,a0,-464 # 7100 <malloc+0x14ae>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    32ec:	ac858593          	add	a1,a1,-1336 # bdb0 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3302:	ab274703          	lbu	a4,-1358(a4) # bdb0 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    331c:	e3858593          	add	a1,a1,-456 # 7150 <malloc+0x14fe>
    3320:	00004517          	auipc	a0,0x4
    3324:	da850513          	add	a0,a0,-600 # 70c8 <malloc+0x1476>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3338:	d9450513          	add	a0,a0,-620 # 70c8 <malloc+0x1476>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    334e:	d7e50513          	add	a0,a0,-642 # 70c8 <malloc+0x1476>
  ...
  if(chdir("dd") != 0){
    ...
    3362:	cca50513          	add	a0,a0,-822 # 7028 <malloc+0x13d6>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3376:	e7650513          	add	a0,a0,-394 # 71e8 <malloc+0x1596>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    338a:	e9250513          	add	a0,a0,-366 # 7218 <malloc+0x15c6>
  ...
  if(chdir("./..") != 0){
    ...
    339e:	eae50513          	add	a0,a0,-338 # 7248 <malloc+0x15f6>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    33b4:	da050513          	add	a0,a0,-608 # 7150 <malloc+0x14fe>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    33cc:	9e858593          	add	a1,a1,-1560 # bdb0 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    33ee:	cde50513          	add	a0,a0,-802 # 70c8 <malloc+0x1476>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3406:	ed650513          	add	a0,a0,-298 # 72d8 <malloc+0x1686>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    341e:	eee50513          	add	a0,a0,-274 # 7308 <malloc+0x16b6>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3436:	bf650513          	add	a0,a0,-1034 # 7028 <malloc+0x13d6>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    344c:	be050513          	add	a0,a0,-1056 # 7028 <malloc+0x13d6>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    3462:	bca50513          	add	a0,a0,-1078 # 7028 <malloc+0x13d6>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3476:	f2658593          	add	a1,a1,-218 # 7398 <malloc+0x1746>
    347a:	00004517          	auipc	a0,0x4
    347e:	e5e50513          	add	a0,a0,-418 # 72d8 <malloc+0x1686>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3492:	f0a58593          	add	a1,a1,-246 # 7398 <malloc+0x1746>
    3496:	00004517          	auipc	a0,0x4
    349a:	e7250513          	add	a0,a0,-398 # 7308 <malloc+0x16b6>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    34ae:	ca658593          	add	a1,a1,-858 # 7150 <malloc+0x14fe>
    34b2:	00004517          	auipc	a0,0x4
    34b6:	b9650513          	add	a0,a0,-1130 # 7048 <malloc+0x13f6>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    34ca:	e1250513          	add	a0,a0,-494 # 72d8 <malloc+0x1686>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    34de:	e2e50513          	add	a0,a0,-466 # 7308 <malloc+0x16b6>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    34f2:	c6250513          	add	a0,a0,-926 # 7150 <malloc+0x14fe>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3506:	e0650513          	add	a0,a0,-506 # 7308 <malloc+0x16b6>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    351a:	dc250513          	add	a0,a0,-574 # 72d8 <malloc+0x1686>
  ...
  if(chdir("dd/ff") == 0){
    ...
    352e:	b1e50513          	add	a0,a0,-1250 # 7048 <malloc+0x13f6>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3542:	faa50513          	add	a0,a0,-86 # 74e8 <malloc+0x1896>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3556:	bfe50513          	add	a0,a0,-1026 # 7150 <malloc+0x14fe>
  ...
  if(unlink("dd/ff") != 0){
    ...
    356a:	ae250513          	add	a0,a0,-1310 # 7048 <malloc+0x13f6>
  ...
  if(unlink("dd") == 0){
    ...
    357e:	aae50513          	add	a0,a0,-1362 # 7028 <malloc+0x13d6>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3592:	fca50513          	add	a0,a0,-54 # 7558 <malloc+0x1906>
  ...
  if(unlink("dd") < 0){
    ...
    35a6:	a8650513          	add	a0,a0,-1402 # 7028 <malloc+0x13d6>
    ...
    35c8:	a6c50513          	add	a0,a0,-1428 # 7030 <malloc+0x13de>
    35cc:	00002097          	auipc	ra,0x2
    35d0:	5ce080e7          	jalr	1486(ra) # 5b9a <printf>
    exit(1);
    35d4:	4505                	li	a0,1
    ...
    35e4:	a7050513          	add	a0,a0,-1424 # 7050 <malloc+0x13fe>
    35e8:	00002097          	auipc	ra,0x2
    35ec:	5b2080e7          	jalr	1458(ra) # 5b9a <printf>
    exit(1);
    35f0:	4505                	li	a0,1
    ...
    3600:	a7450513          	add	a0,a0,-1420 # 7070 <malloc+0x141e>
    3604:	00002097          	auipc	ra,0x2
    3608:	596080e7          	jalr	1430(ra) # 5b9a <printf>
    exit(1);
    360c:	4505                	li	a0,1
    ...
    361c:	a9050513          	add	a0,a0,-1392 # 70a8 <malloc+0x1456>
    3620:	00002097          	auipc	ra,0x2
    3624:	57a080e7          	jalr	1402(ra) # 5b9a <printf>
    exit(1);
    3628:	4505                	li	a0,1
    ...
    3638:	aa450513          	add	a0,a0,-1372 # 70d8 <malloc+0x1486>
    363c:	00002097          	auipc	ra,0x2
    3640:	55e080e7          	jalr	1374(ra) # 5b9a <printf>
    exit(1);
    3644:	4505                	li	a0,1
    ...
    3654:	ac050513          	add	a0,a0,-1344 # 7110 <malloc+0x14be>
    3658:	00002097          	auipc	ra,0x2
    365c:	542080e7          	jalr	1346(ra) # 5b9a <printf>
    exit(1);
    3660:	4505                	li	a0,1
    ...
    3670:	ac450513          	add	a0,a0,-1340 # 7130 <malloc+0x14de>
    3674:	00002097          	auipc	ra,0x2
    3678:	526080e7          	jalr	1318(ra) # 5b9a <printf>
    exit(1);
    367c:	4505                	li	a0,1
    ...
    368c:	ad850513          	add	a0,a0,-1320 # 7160 <malloc+0x150e>
    3690:	00002097          	auipc	ra,0x2
    3694:	50a080e7          	jalr	1290(ra) # 5b9a <printf>
    exit(1);
    3698:	4505                	li	a0,1
    ...
    36a8:	ae450513          	add	a0,a0,-1308 # 7188 <malloc+0x1536>
    36ac:	00002097          	auipc	ra,0x2
    36b0:	4ee080e7          	jalr	1262(ra) # 5b9a <printf>
    exit(1);
    36b4:	4505                	li	a0,1
    ...
    36c4:	ae850513          	add	a0,a0,-1304 # 71a8 <malloc+0x1556>
    36c8:	00002097          	auipc	ra,0x2
    36cc:	4d2080e7          	jalr	1234(ra) # 5b9a <printf>
    exit(1);
    36d0:	4505                	li	a0,1
    ...
    36e0:	af450513          	add	a0,a0,-1292 # 71d0 <malloc+0x157e>
    36e4:	00002097          	auipc	ra,0x2
    36e8:	4b6080e7          	jalr	1206(ra) # 5b9a <printf>
    exit(1);
    36ec:	4505                	li	a0,1
    ...
    36fc:	b0050513          	add	a0,a0,-1280 # 71f8 <malloc+0x15a6>
    3700:	00002097          	auipc	ra,0x2
    3704:	49a080e7          	jalr	1178(ra) # 5b9a <printf>
    exit(1);
    3708:	4505                	li	a0,1
    ...
    3718:	b1450513          	add	a0,a0,-1260 # 7228 <malloc+0x15d6>
    371c:	00002097          	auipc	ra,0x2
    3720:	47e080e7          	jalr	1150(ra) # 5b9a <printf>
    exit(1);
    3724:	4505                	li	a0,1
    ...
    3734:	b2050513          	add	a0,a0,-1248 # 7250 <malloc+0x15fe>
    3738:	00002097          	auipc	ra,0x2
    373c:	462080e7          	jalr	1122(ra) # 5b9a <printf>
    exit(1);
    3740:	4505                	li	a0,1
    ...
    3750:	b1c50513          	add	a0,a0,-1252 # 7268 <malloc+0x1616>
    3754:	00002097          	auipc	ra,0x2
    3758:	446080e7          	jalr	1094(ra) # 5b9a <printf>
    exit(1);
    375c:	4505                	li	a0,1
    ...
    376c:	b2050513          	add	a0,a0,-1248 # 7288 <malloc+0x1636>
    3770:	00002097          	auipc	ra,0x2
    3774:	42a080e7          	jalr	1066(ra) # 5b9a <printf>
    exit(1);
    3778:	4505                	li	a0,1
    ...
    3788:	b2450513          	add	a0,a0,-1244 # 72a8 <malloc+0x1656>
    378c:	00002097          	auipc	ra,0x2
    3790:	40e080e7          	jalr	1038(ra) # 5b9a <printf>
    exit(1);
    3794:	4505                	li	a0,1
    ...
    37a4:	b4850513          	add	a0,a0,-1208 # 72e8 <malloc+0x1696>
    37a8:	00002097          	auipc	ra,0x2
    37ac:	3f2080e7          	jalr	1010(ra) # 5b9a <printf>
    exit(1);
    37b0:	4505                	li	a0,1
    ...
    37c0:	b5c50513          	add	a0,a0,-1188 # 7318 <malloc+0x16c6>
    37c4:	00002097          	auipc	ra,0x2
    37c8:	3d6080e7          	jalr	982(ra) # 5b9a <printf>
    exit(1);
    37cc:	4505                	li	a0,1
    ...
    37dc:	b6050513          	add	a0,a0,-1184 # 7338 <malloc+0x16e6>
    37e0:	00002097          	auipc	ra,0x2
    37e4:	3ba080e7          	jalr	954(ra) # 5b9a <printf>
    exit(1);
    37e8:	4505                	li	a0,1
    ...
    37f8:	b6450513          	add	a0,a0,-1180 # 7358 <malloc+0x1706>
    37fc:	00002097          	auipc	ra,0x2
    3800:	39e080e7          	jalr	926(ra) # 5b9a <printf>
    exit(1);
    3804:	4505                	li	a0,1
    ...
    3814:	b6850513          	add	a0,a0,-1176 # 7378 <malloc+0x1726>
    3818:	00002097          	auipc	ra,0x2
    381c:	382080e7          	jalr	898(ra) # 5b9a <printf>
    exit(1);
    3820:	4505                	li	a0,1
    ...
    3830:	b7c50513          	add	a0,a0,-1156 # 73a8 <malloc+0x1756>
    3834:	00002097          	auipc	ra,0x2
    3838:	366080e7          	jalr	870(ra) # 5b9a <printf>
    exit(1);
    383c:	4505                	li	a0,1
    ...
    384c:	b8850513          	add	a0,a0,-1144 # 73d0 <malloc+0x177e>
    3850:	00002097          	auipc	ra,0x2
    3854:	34a080e7          	jalr	842(ra) # 5b9a <printf>
    exit(1);
    3858:	4505                	li	a0,1
    ...
    3868:	b9450513          	add	a0,a0,-1132 # 73f8 <malloc+0x17a6>
    386c:	00002097          	auipc	ra,0x2
    3870:	32e080e7          	jalr	814(ra) # 5b9a <printf>
    exit(1);
    3874:	4505                	li	a0,1
    ...
    3884:	ba050513          	add	a0,a0,-1120 # 7420 <malloc+0x17ce>
    3888:	00002097          	auipc	ra,0x2
    388c:	312080e7          	jalr	786(ra) # 5b9a <printf>
    exit(1);
    3890:	4505                	li	a0,1
    ...
    38a0:	ba450513          	add	a0,a0,-1116 # 7440 <malloc+0x17ee>
    38a4:	00002097          	auipc	ra,0x2
    38a8:	2f6080e7          	jalr	758(ra) # 5b9a <printf>
    exit(1);
    38ac:	4505                	li	a0,1
    ...
    38bc:	ba850513          	add	a0,a0,-1112 # 7460 <malloc+0x180e>
    38c0:	00002097          	auipc	ra,0x2
    38c4:	2da080e7          	jalr	730(ra) # 5b9a <printf>
    exit(1);
    38c8:	4505                	li	a0,1
    ...
    38d8:	bb450513          	add	a0,a0,-1100 # 7488 <malloc+0x1836>
    38dc:	00002097          	auipc	ra,0x2
    38e0:	2be080e7          	jalr	702(ra) # 5b9a <printf>
    exit(1);
    38e4:	4505                	li	a0,1
    ...
    38f4:	bb850513          	add	a0,a0,-1096 # 74a8 <malloc+0x1856>
    38f8:	00002097          	auipc	ra,0x2
    38fc:	2a2080e7          	jalr	674(ra) # 5b9a <printf>
    exit(1);
    3900:	4505                	li	a0,1
    ...
    3910:	bbc50513          	add	a0,a0,-1092 # 74c8 <malloc+0x1876>
    3914:	00002097          	auipc	ra,0x2
    3918:	286080e7          	jalr	646(ra) # 5b9a <printf>
    exit(1);
    391c:	4505                	li	a0,1
    ...
    392c:	bc850513          	add	a0,a0,-1080 # 74f0 <malloc+0x189e>
    3930:	00002097          	auipc	ra,0x2
    3934:	26a080e7          	jalr	618(ra) # 5b9a <printf>
    exit(1);
    3938:	4505                	li	a0,1
    ...
    3948:	84450513          	add	a0,a0,-1980 # 7188 <malloc+0x1536>
    394c:	00002097          	auipc	ra,0x2
    3950:	24e080e7          	jalr	590(ra) # 5b9a <printf>
    exit(1);
    3954:	4505                	li	a0,1
    ...
    3964:	bb050513          	add	a0,a0,-1104 # 7510 <malloc+0x18be>
    3968:	00002097          	auipc	ra,0x2
    396c:	232080e7          	jalr	562(ra) # 5b9a <printf>
    exit(1);
    3970:	4505                	li	a0,1
    ...
    3980:	bb450513          	add	a0,a0,-1100 # 7530 <malloc+0x18de>
    3984:	00002097          	auipc	ra,0x2
    3988:	216080e7          	jalr	534(ra) # 5b9a <printf>
    exit(1);
    398c:	4505                	li	a0,1
    ...
    399c:	bc850513          	add	a0,a0,-1080 # 7560 <malloc+0x190e>
    39a0:	00002097          	auipc	ra,0x2
    39a4:	1fa080e7          	jalr	506(ra) # 5b9a <printf>
    exit(1);
    39a8:	4505                	li	a0,1
    ...
    39b8:	bcc50513          	add	a0,a0,-1076 # 7580 <malloc+0x192e>
    39bc:	00002097          	auipc	ra,0x2
    39c0:	1de080e7          	jalr	478(ra) # 5b9a <printf>
    exit(1);
    39c4:	4505                	li	a0,1
...
00000000000039ce <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    39de:	bbe50513          	add	a0,a0,-1090 # 7598 <malloc+0x1946>
  ...
  if(chdir("dots") != 0){
    ...
    39f0:	bac50513          	add	a0,a0,-1108 # 7598 <malloc+0x1946>
  ...
  if(unlink(".") == 0){
    ...
    3a02:	a2a50513          	add	a0,a0,-1494 # 6428 <malloc+0x7d6>
  ...
  if(unlink("..") == 0){
    ...
    3a14:	5e050513          	add	a0,a0,1504 # 6ff0 <malloc+0x139e>
  ...
  if(chdir("/") != 0){
    ...
    3a26:	57650513          	add	a0,a0,1398 # 6f98 <malloc+0x1346>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a38:	bcc50513          	add	a0,a0,-1076 # 7600 <malloc+0x19ae>
  ...
  if(unlink("dots/..") == 0){
    ...
    3a4a:	be250513          	add	a0,a0,-1054 # 7628 <malloc+0x19d6>
  ...
  if(unlink("dots") != 0){
    ...
    3a5c:	b4050513          	add	a0,a0,-1216 # 7598 <malloc+0x1946>
    ...
    3a7a:	b2a50513          	add	a0,a0,-1238 # 75a0 <malloc+0x194e>
    3a7e:	00002097          	auipc	ra,0x2
    3a82:	11c080e7          	jalr	284(ra) # 5b9a <printf>
    exit(1);
    3a86:	4505                	li	a0,1
    ...
    3a96:	b2650513          	add	a0,a0,-1242 # 75b8 <malloc+0x1966>
    3a9a:	00002097          	auipc	ra,0x2
    3a9e:	100080e7          	jalr	256(ra) # 5b9a <printf>
    exit(1);
    3aa2:	4505                	li	a0,1
    ...
    3ab2:	b2250513          	add	a0,a0,-1246 # 75d0 <malloc+0x197e>
    3ab6:	00002097          	auipc	ra,0x2
    3aba:	0e4080e7          	jalr	228(ra) # 5b9a <printf>
    exit(1);
    3abe:	4505                	li	a0,1
    ...
    3ace:	b1e50513          	add	a0,a0,-1250 # 75e8 <malloc+0x1996>
    3ad2:	00002097          	auipc	ra,0x2
    3ad6:	0c8080e7          	jalr	200(ra) # 5b9a <printf>
    exit(1);
    3ada:	4505                	li	a0,1
    ...
    3aea:	4ba50513          	add	a0,a0,1210 # 6fa0 <malloc+0x134e>
    3aee:	00002097          	auipc	ra,0x2
    3af2:	0ac080e7          	jalr	172(ra) # 5b9a <printf>
    exit(1);
    3af6:	4505                	li	a0,1
    ...
    3b06:	b0650513          	add	a0,a0,-1274 # 7608 <malloc+0x19b6>
    3b0a:	00002097          	auipc	ra,0x2
    3b0e:	090080e7          	jalr	144(ra) # 5b9a <printf>
    exit(1);
    3b12:	4505                	li	a0,1
    ...
    3b22:	b1250513          	add	a0,a0,-1262 # 7630 <malloc+0x19de>
    3b26:	00002097          	auipc	ra,0x2
    3b2a:	074080e7          	jalr	116(ra) # 5b9a <printf>
    exit(1);
    3b2e:	4505                	li	a0,1
    ...
    3b3e:	b1650513          	add	a0,a0,-1258 # 7650 <malloc+0x19fe>
    3b42:	00002097          	auipc	ra,0x2
    3b46:	058080e7          	jalr	88(ra) # 5b9a <printf>
    exit(1);
    3b4a:	4505                	li	a0,1
...
0000000000003b54 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3b6a:	b0a50513          	add	a0,a0,-1270 # 7670 <malloc+0x1a1e>
  ...
  if(chdir("dirfile") == 0){
    ...
    3b86:	aee50513          	add	a0,a0,-1298 # 7670 <malloc+0x1a1e>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3b9a:	b2250513          	add	a0,a0,-1246 # 76b8 <malloc+0x1a66>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3bb2:	b0a50513          	add	a0,a0,-1270 # 76b8 <malloc+0x1a66>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3bc6:	af650513          	add	a0,a0,-1290 # 76b8 <malloc+0x1a66>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3bda:	ae250513          	add	a0,a0,-1310 # 76b8 <malloc+0x1a66>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3bee:	ace58593          	add	a1,a1,-1330 # 76b8 <malloc+0x1a66>
    3bf2:	00002517          	auipc	a0,0x2
    3bf6:	32650513          	add	a0,a0,806 # 5f18 <malloc+0x2c6>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c0a:	a6a50513          	add	a0,a0,-1430 # 7670 <malloc+0x1a1e>
  ...
  fd = open(".", O_RDWR);
    ...
    3c20:	80c50513          	add	a0,a0,-2036 # 6428 <malloc+0x7d6>
  ...
  fd = open(".", 0);
    ...
    3c36:	7f650513          	add	a0,a0,2038 # 6428 <malloc+0x7d6>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3c4a:	19a58593          	add	a1,a1,410 # 5de0 <malloc+0x18e>
  ...
  close(fd);
    ...
    3c76:	a0650513          	add	a0,a0,-1530 # 7678 <malloc+0x1a26>
    3c7a:	00002097          	auipc	ra,0x2
    3c7e:	f20080e7          	jalr	-224(ra) # 5b9a <printf>
    exit(1);
    3c82:	4505                	li	a0,1
    ...
    3c92:	a0a50513          	add	a0,a0,-1526 # 7698 <malloc+0x1a46>
    3c96:	00002097          	auipc	ra,0x2
    3c9a:	f04080e7          	jalr	-252(ra) # 5b9a <printf>
    exit(1);
    3c9e:	4505                	li	a0,1
    ...
    3cae:	a1e50513          	add	a0,a0,-1506 # 76c8 <malloc+0x1a76>
    3cb2:	00002097          	auipc	ra,0x2
    3cb6:	ee8080e7          	jalr	-280(ra) # 5b9a <printf>
    exit(1);
    3cba:	4505                	li	a0,1
    ...
    3cca:	a0250513          	add	a0,a0,-1534 # 76c8 <malloc+0x1a76>
    3cce:	00002097          	auipc	ra,0x2
    3cd2:	ecc080e7          	jalr	-308(ra) # 5b9a <printf>
    exit(1);
    3cd6:	4505                	li	a0,1
    ...
    3ce6:	a0e50513          	add	a0,a0,-1522 # 76f0 <malloc+0x1a9e>
    3cea:	00002097          	auipc	ra,0x2
    3cee:	eb0080e7          	jalr	-336(ra) # 5b9a <printf>
    exit(1);
    3cf2:	4505                	li	a0,1
    ...
    3d02:	a1a50513          	add	a0,a0,-1510 # 7718 <malloc+0x1ac6>
    3d06:	00002097          	auipc	ra,0x2
    3d0a:	e94080e7          	jalr	-364(ra) # 5b9a <printf>
    exit(1);
    3d0e:	4505                	li	a0,1
    ...
    3d1e:	a2650513          	add	a0,a0,-1498 # 7740 <malloc+0x1aee>
    3d22:	00002097          	auipc	ra,0x2
    3d26:	e78080e7          	jalr	-392(ra) # 5b9a <printf>
    exit(1);
    3d2a:	4505                	li	a0,1
    ...
    3d3a:	a3250513          	add	a0,a0,-1486 # 7768 <malloc+0x1b16>
    3d3e:	00002097          	auipc	ra,0x2
    3d42:	e5c080e7          	jalr	-420(ra) # 5b9a <printf>
    exit(1);
    3d46:	4505                	li	a0,1
    ...
    3d56:	a3650513          	add	a0,a0,-1482 # 7788 <malloc+0x1b36>
    3d5a:	00002097          	auipc	ra,0x2
    3d5e:	e40080e7          	jalr	-448(ra) # 5b9a <printf>
    exit(1);
    3d62:	4505                	li	a0,1
    ...
    3d72:	a4250513          	add	a0,a0,-1470 # 77b0 <malloc+0x1b5e>
    3d76:	00002097          	auipc	ra,0x2
    3d7a:	e24080e7          	jalr	-476(ra) # 5b9a <printf>
    exit(1);
    3d7e:	4505                	li	a0,1
...
0000000000003d88 <iref>:
{
    ...
    3da6:	a26a0a13          	add	s4,s4,-1498 # 77c8 <malloc+0x1b76>
    mkdir("");
    3daa:	00003497          	auipc	s1,0x3
    3dae:	52648493          	add	s1,s1,1318 # 72d0 <malloc+0x167e>
    link("README", "");
    3db2:	00002a97          	auipc	s5,0x2
    3db6:	166a8a93          	add	s5,s5,358 # 5f18 <malloc+0x2c6>
    fd = open("xx", O_CREATE);
    3dba:	00004997          	auipc	s3,0x4
    3dbe:	90698993          	add	s3,s3,-1786 # 76c0 <malloc+0x1a6e>
    3dc2:	a891                	j	3e16 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3dc4:	85da                	mv	a1,s6
    3dc6:	00004517          	auipc	a0,0x4
    3dca:	a0a50513          	add	a0,a0,-1526 # 77d0 <malloc+0x1b7e>
    3dce:	00002097          	auipc	ra,0x2
    3dd2:	dcc080e7          	jalr	-564(ra) # 5b9a <printf>
      exit(1);
    3dd6:	4505                	li	a0,1
    ...
    3de6:	a0650513          	add	a0,a0,-1530 # 77e8 <malloc+0x1b96>
    3dea:	00002097          	auipc	ra,0x2
    3dee:	db0080e7          	jalr	-592(ra) # 5b9a <printf>
      exit(1);
    3df2:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3e7a:	17a98993          	add	s3,s3,378 # 6ff0 <malloc+0x139e>
    unlink("irefd");
    3e7e:	00004917          	auipc	s2,0x4
    3e82:	94a90913          	add	s2,s2,-1718 # 77c8 <malloc+0x1b76>
    chdir("..");
    3e86:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3ea2:	0fa50513          	add	a0,a0,250 # 6f98 <malloc+0x1346>
...
0000000000003ec2 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3ed2:	93250513          	add	a0,a0,-1742 # 7800 <malloc+0x1bae>
  ...
  if(pid == 0){
    ...
    3ef6:	90e50513          	add	a0,a0,-1778 # 7800 <malloc+0x1bae>
    ...
    3f0c:	91850513          	add	a0,a0,-1768 # 7820 <malloc+0x1bce>
    3f10:	00002097          	auipc	ra,0x2
    3f14:	c8a080e7          	jalr	-886(ra) # 5b9a <printf>
      exit(1);
    3f18:	4505                	li	a0,1
    ...
    3f28:	8e450513          	add	a0,a0,-1820 # 7808 <malloc+0x1bb6>
    3f2c:	00002097          	auipc	ra,0x2
    3f30:	c6e080e7          	jalr	-914(ra) # 5b9a <printf>
    exit(1);
    3f34:	4505                	li	a0,1
    ...
    3f44:	68850513          	add	a0,a0,1672 # 65c8 <malloc+0x976>
    3f48:	00002097          	auipc	ra,0x2
    3f4c:	c52080e7          	jalr	-942(ra) # 5b9a <printf>
    exit(1);
    3f50:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3f72:	89250513          	add	a0,a0,-1902 # 7800 <malloc+0x1bae>
    ...
    3f86:	83650513          	add	a0,a0,-1994 # 67b8 <malloc+0xb66>
    3f8a:	00002097          	auipc	ra,0x2
    3f8e:	c10080e7          	jalr	-1008(ra) # 5b9a <printf>
    exit(1);
    3f92:	4505                	li	a0,1
...
0000000000003fb4 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3fc4:	88850513          	add	a0,a0,-1912 # 7848 <malloc+0x1bf6>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3ff0:	85c50513          	add	a0,a0,-1956 # 7848 <malloc+0x1bf6>
  ...
  sleep(10); // one second
    ...
    4028:	76450513          	add	a0,a0,1892 # 6788 <malloc+0xb36>
    402c:	00002097          	auipc	ra,0x2
    4030:	b6e080e7          	jalr	-1170(ra) # 5b9a <printf>
    exit(1);
    4034:	4505                	li	a0,1
    ...
    4042:	80a48493          	add	s1,s1,-2038 # 7848 <malloc+0x1bf6>
    4046:	4581                	li	a1,0
    4048:	8526                	mv	a0,s1
    ...
    406a:	7e250513          	add	a0,a0,2018 # 7848 <malloc+0x1bf6>
...
000000000000408a <killstatus>:
{
  ...
  exit(0);
    ...
    40f0:	4dc50513          	add	a0,a0,1244 # 65c8 <malloc+0x976>
    40f4:	00002097          	auipc	ra,0x2
    40f8:	aa6080e7          	jalr	-1370(ra) # 5b9a <printf>
      exit(1);
    40fc:	4505                	li	a0,1
    ...
    4116:	74650513          	add	a0,a0,1862 # 7858 <malloc+0x1c06>
    411a:	00002097          	auipc	ra,0x2
    411e:	a80080e7          	jalr	-1408(ra) # 5b9a <printf>
       exit(1);
    4122:	4505                	li	a0,1
...
000000000000412c <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    4156:	63650513          	add	a0,a0,1590 # 6788 <malloc+0xb36>
    415a:	00002097          	auipc	ra,0x2
    415e:	a40080e7          	jalr	-1472(ra) # 5b9a <printf>
    exit(1);
    4162:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    4184:	44850513          	add	a0,a0,1096 # 65c8 <malloc+0x976>
    4188:	00002097          	auipc	ra,0x2
    418c:	a12080e7          	jalr	-1518(ra) # 5b9a <printf>
    exit(1);
    4190:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    41c8:	c1c58593          	add	a1,a1,-996 # 5de0 <malloc+0x18e>
    ...
    41f2:	3da50513          	add	a0,a0,986 # 65c8 <malloc+0x976>
    41f6:	00002097          	auipc	ra,0x2
    41fa:	9a4080e7          	jalr	-1628(ra) # 5b9a <printf>
     exit(1);
    41fe:	4505                	li	a0,1
    ...
    420e:	66e50513          	add	a0,a0,1646 # 7878 <malloc+0x1c26>
    4212:	00002097          	auipc	ra,0x2
    4216:	988080e7          	jalr	-1656(ra) # 5b9a <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    422e:	b8658593          	add	a1,a1,-1146 # bdb0 <buf>
    ...
    424a:	64a50513          	add	a0,a0,1610 # 7890 <malloc+0x1c3e>
    424e:	00002097          	auipc	ra,0x2
    4252:	94c080e7          	jalr	-1716(ra) # 5b9a <printf>
}
  ...
  printf("kill... ");
    ...
    4276:	63650513          	add	a0,a0,1590 # 78a8 <malloc+0x1c56>
    427a:	00002097          	auipc	ra,0x2
    427e:	920080e7          	jalr	-1760(ra) # 5b9a <printf>
  kill(pid1);
    4282:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    42a4:	61850513          	add	a0,a0,1560 # 78b8 <malloc+0x1c66>
    42a8:	00002097          	auipc	ra,0x2
    42ac:	8f2080e7          	jalr	-1806(ra) # 5b9a <printf>
  wait(0);
    42b0:	4501                	li	a0,0
...
00000000000042d0 <reparent>:
{
  ...
  exit(0);
    ...
    4324:	2a850513          	add	a0,a0,680 # 65c8 <malloc+0x976>
    4328:	00002097          	auipc	ra,0x2
    432c:	872080e7          	jalr	-1934(ra) # 5b9a <printf>
      exit(1);
    4330:	4505                	li	a0,1
    ...
    4340:	41450513          	add	a0,a0,1044 # 6750 <malloc+0xafe>
    4344:	00002097          	auipc	ra,0x2
    4348:	856080e7          	jalr	-1962(ra) # 5b9a <printf>
        exit(1);
    434c:	4505                	li	a0,1
...
0000000000004380 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    43b6:	31e50513          	add	a0,a0,798 # 66d0 <malloc+0xa7e>
    43ba:	00001097          	auipc	ra,0x1
    43be:	7e0080e7          	jalr	2016(ra) # 5b9a <printf>
    exit(1);
    43c2:	4505                	li	a0,1
    ...
    43ea:	9fa58593          	add	a1,a1,-1542 # 5de0 <malloc+0x18e>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    44ae:	41e50513          	add	a0,a0,1054 # 78c8 <malloc+0x1c76>
    44b2:	00001097          	auipc	ra,0x1
    44b6:	6e8080e7          	jalr	1768(ra) # 5b9a <printf>
    exit(1);
    44ba:	4505                	li	a0,1
    ...
    44ca:	10250513          	add	a0,a0,258 # 65c8 <malloc+0x976>
    44ce:	00001097          	auipc	ra,0x1
    44d2:	6cc080e7          	jalr	1740(ra) # 5b9a <printf>
    exit(1);
    44d6:	4505                	li	a0,1
    ...
    4500:	6705                	lui	a4,0x1
      n += *(a+i);
    4502:	0007c683          	lbu	a3,0(a5) # 6400000 <__BSS_END__+0x63f1240>
    ...
    4516:	3d650513          	add	a0,a0,982 # 78e8 <malloc+0x1c96>
    451a:	00001097          	auipc	ra,0x1
    451e:	680080e7          	jalr	1664(ra) # 5b9a <printf>
    exit(1);
    4522:	4505                	li	a0,1
...
0000000000004536 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4580:	6d6080e7          	jalr	1750(ra) # 5c52 <malloc>
    ...
    45ba:	36250513          	add	a0,a0,866 # 7918 <malloc+0x1cc6>
    45be:	00001097          	auipc	ra,0x1
    45c2:	5dc080e7          	jalr	1500(ra) # 5b9a <printf>
      exit(1);
    45c6:	4505                	li	a0,1
...
00000000000045da <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4670:	2dc50513          	add	a0,a0,732 # 7948 <malloc+0x1cf6>
    4674:	00001097          	auipc	ra,0x1
    4678:	526080e7          	jalr	1318(ra) # 5b9a <printf>
    exit(1);
    467c:	4505                	li	a0,1
    ...
    468c:	2e850513          	add	a0,a0,744 # 7970 <malloc+0x1d1e>
    4690:	00001097          	auipc	ra,0x1
    4694:	50a080e7          	jalr	1290(ra) # 5b9a <printf>
      exit(1);
    4698:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    46d0:	26c50513          	add	a0,a0,620 # 7938 <malloc+0x1ce6>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4710:	28450513          	add	a0,a0,644 # 7990 <malloc+0x1d3e>
    4714:	00001097          	auipc	ra,0x1
    4718:	486080e7          	jalr	1158(ra) # 5b9a <printf>
    exit(1);
    471c:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    474c:	1f050513          	add	a0,a0,496 # 7938 <malloc+0x1ce6>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4772:	24a50513          	add	a0,a0,586 # 79b8 <malloc+0x1d66>
    4776:	00001097          	auipc	ra,0x1
    477a:	424080e7          	jalr	1060(ra) # 5b9a <printf>
    exit(1);
    477e:	4505                	li	a0,1
...
0000000000004792 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    47b6:	21e78793          	add	a5,a5,542 # 79d0 <malloc+0x1d7e>
    47ba:	f6f43823          	sd	a5,-144(s0)
    47be:	00003797          	auipc	a5,0x3
    47c2:	21a78793          	add	a5,a5,538 # 79d8 <malloc+0x1d86>
    47c6:	f6f43c23          	sd	a5,-136(s0)
    47ca:	00003797          	auipc	a5,0x3
    47ce:	21678793          	add	a5,a5,534 # 79e0 <malloc+0x1d8e>
    47d2:	f8f43023          	sd	a5,-128(s0)
    47d6:	00003797          	auipc	a5,0x3
    47da:	21278793          	add	a5,a5,530 # 79e8 <malloc+0x1d96>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    4832:	582a0a13          	add	s4,s4,1410 # bdb0 <buf>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4848:	1a450513          	add	a0,a0,420 # 69e8 <malloc+0xd96>
    484c:	00001097          	auipc	ra,0x1
    4850:	34e080e7          	jalr	846(ra) # 5b9a <printf>
      exit(1);
    4854:	4505                	li	a0,1
    ...
    48c2:	13250513          	add	a0,a0,306 # 79f0 <malloc+0x1d9e>
    48c6:	00001097          	auipc	ra,0x1
    48ca:	2d4080e7          	jalr	724(ra) # 5b9a <printf>
        exit(1);
    48ce:	4505                	li	a0,1
    ...
    48dc:	12850513          	add	a0,a0,296 # 7a00 <malloc+0x1dae>
    48e0:	00001097          	auipc	ra,0x1
    48e4:	2ba080e7          	jalr	698(ra) # 5b9a <printf>
          exit(1);
    48e8:	4505                	li	a0,1
    ...
    4902:	11a50513          	add	a0,a0,282 # 7a18 <malloc+0x1dc6>
    4906:	00001097          	auipc	ra,0x1
    490a:	294080e7          	jalr	660(ra) # 5b9a <printf>
          exit(1);
    490e:	4505                	li	a0,1
    ...
    4932:	48278793          	add	a5,a5,1154 # bdb0 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    498a:	0a250513          	add	a0,a0,162 # 7a28 <malloc+0x1dd6>
    498e:	00001097          	auipc	ra,0x1
    4992:	20c080e7          	jalr	524(ra) # 5b9a <printf>
      exit(1);
    4996:	4505                	li	a0,1
...
00000000000049be <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    49ec:	058b8b93          	add	s7,s7,88 # 7a40 <malloc+0x1dee>
  for(i = 0; i < N; i++){
    ...
    4a2e:	01e50513          	add	a0,a0,30 # 7a48 <malloc+0x1df6>
    4a32:	00001097          	auipc	ra,0x1
    4a36:	168080e7          	jalr	360(ra) # 5b9a <printf>
        exit(1);
    4a3a:	4505                	li	a0,1
    ...
    4a4c:	ff850513          	add	a0,a0,-8 # 7a40 <malloc+0x1dee>
  ...
  fd = open(".", 0);
    ...
    4a84:	9a850513          	add	a0,a0,-1624 # 6428 <malloc+0x7d6>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4afc:	f7050513          	add	a0,a0,-144 # 7a68 <malloc+0x1e16>
    4b00:	00001097          	auipc	ra,0x1
    4b04:	09a080e7          	jalr	154(ra) # 5b9a <printf>
        exit(1);
    4b08:	4505                	li	a0,1
    ...
    4b1c:	f7050513          	add	a0,a0,-144 # 7a88 <malloc+0x1e36>
    4b20:	00001097          	auipc	ra,0x1
    4b24:	07a080e7          	jalr	122(ra) # 5b9a <printf>
        exit(1);
    4b28:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4b54:	f6050513          	add	a0,a0,-160 # 7ab0 <malloc+0x1e5e>
    4b58:	00001097          	auipc	ra,0x1
    4b5c:	042080e7          	jalr	66(ra) # 5b9a <printf>
    exit(1);
    4b60:	4505                	li	a0,1
    ...
    4b70:	a5c50513          	add	a0,a0,-1444 # 65c8 <malloc+0x976>
    4b74:	00001097          	auipc	ra,0x1
    4b78:	026080e7          	jalr	38(ra) # 5b9a <printf>
      exit(1);
    4b7c:	4505                	li	a0,1
...
0000000000004d1a <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4d5a:	05a90913          	add	s2,s2,90 # bdb0 <buf>
  for(i = 0; i < N; i++){
    4d5e:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4da2:	d4a50513          	add	a0,a0,-694 # 7ae8 <malloc+0x1e96>
  ...
  for(i = 0; ; i++){
    ...
    4db8:	ffc90913          	add	s2,s2,-4 # bdb0 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4e06:	cf650513          	add	a0,a0,-778 # 7af8 <malloc+0x1ea6>
    4e0a:	00001097          	auipc	ra,0x1
    4e0e:	d90080e7          	jalr	-624(ra) # 5b9a <printf>
    exit(1);
    4e12:	4505                	li	a0,1
    ...
    4e22:	cfa50513          	add	a0,a0,-774 # 7b18 <malloc+0x1ec6>
    4e26:	00001097          	auipc	ra,0x1
    4e2a:	d74080e7          	jalr	-652(ra) # 5b9a <printf>
      exit(1);
    4e2e:	4505                	li	a0,1
    ...
    4e3e:	cfe50513          	add	a0,a0,-770 # 7b38 <malloc+0x1ee6>
    4e42:	00001097          	auipc	ra,0x1
    4e46:	d58080e7          	jalr	-680(ra) # 5b9a <printf>
    exit(1);
    4e4a:	4505                	li	a0,1
    ...
    4e5a:	d0250513          	add	a0,a0,-766 # 7b58 <malloc+0x1f06>
    4e5e:	00001097          	auipc	ra,0x1
    4e62:	d3c080e7          	jalr	-708(ra) # 5b9a <printf>
      exit(1);
    4e66:	4505                	li	a0,1
    ...
    4e76:	d0650513          	add	a0,a0,-762 # 7b78 <malloc+0x1f26>
    4e7a:	00001097          	auipc	ra,0x1
    4e7e:	d20080e7          	jalr	-736(ra) # 5b9a <printf>
      exit(1);
    4e82:	4505                	li	a0,1
    ...
    4e92:	d0250513          	add	a0,a0,-766 # 7b90 <malloc+0x1f3e>
    4e96:	00001097          	auipc	ra,0x1
    4e9a:	d04080e7          	jalr	-764(ra) # 5b9a <printf>
      exit(1);
    4e9e:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    4ec0:	c2c50513          	add	a0,a0,-980 # 7ae8 <malloc+0x1e96>
    ...
    4ee4:	cd050513          	add	a0,a0,-816 # 7bb0 <malloc+0x1f5e>
    4ee8:	00001097          	auipc	ra,0x1
    4eec:	cb2080e7          	jalr	-846(ra) # 5b9a <printf>
    exit(1);
    4ef0:	4505                	li	a0,1
...
0000000000004efa <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4f1a:	cba50513          	add	a0,a0,-838 # 7bd0 <malloc+0x1f7e>
    4f1e:	00001097          	auipc	ra,0x1
    4f22:	c7c080e7          	jalr	-900(ra) # 5b9a <printf>
  for(nfiles = 0; ; nfiles++){
    4f26:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4f3a:	caac8c93          	add	s9,s9,-854 # 7be0 <malloc+0x1f8e>
    name[0] = 'f';
    ...
    4f88:	c16080e7          	jalr	-1002(ra) # 5b9a <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    4faa:	c4a50513          	add	a0,a0,-950 # 7bf0 <malloc+0x1f9e>
    4fae:	00001097          	auipc	ra,0x1
    4fb2:	bec080e7          	jalr	-1044(ra) # 5b9a <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    5020:	bf450513          	add	a0,a0,-1036 # 7c10 <malloc+0x1fbe>
    5024:	00001097          	auipc	ra,0x1
    5028:	b76080e7          	jalr	-1162(ra) # 5b9a <printf>
}
    ...
    504e:	d66a8a93          	add	s5,s5,-666 # bdb0 <buf>
      if(cc < BSIZE)
    ...
    5076:	b8e50513          	add	a0,a0,-1138 # 7c00 <malloc+0x1fae>
    507a:	00001097          	auipc	ra,0x1
    507e:	b20080e7          	jalr	-1248(ra) # 5b9a <printf>
    close(fd);
    5082:	854a                	mv	a0,s2
...
0000000000005094 <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    5108:	b2450513          	add	a0,a0,-1244 # 7c28 <malloc+0x1fd6>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    5120:	cc458593          	add	a1,a1,-828 # 5de0 <malloc+0x18e>
    ...
    5136:	b1650513          	add	a0,a0,-1258 # 7c48 <malloc+0x1ff6>
    513a:	00001097          	auipc	ra,0x1
    513e:	a60080e7          	jalr	-1440(ra) # 5b9a <printf>
    exit(1);
    5142:	4505                	li	a0,1
    ...
    5150:	ae450513          	add	a0,a0,-1308 # 7c30 <malloc+0x1fde>
    5154:	00001097          	auipc	ra,0x1
    5158:	a46080e7          	jalr	-1466(ra) # 5b9a <printf>
      exit(1);
    515c:	4505                	li	a0,1
    ...
    516a:	aca50513          	add	a0,a0,-1334 # 7c30 <malloc+0x1fde>
    516e:	00001097          	auipc	ra,0x1
    5172:	a2c080e7          	jalr	-1492(ra) # 5b9a <printf>
    exit(1);
    5176:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    518e:	a9e50513          	add	a0,a0,-1378 # 7c28 <malloc+0x1fd6>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    51e4:	c0098993          	add	s3,s3,-1024 # 5de0 <malloc+0x18e>
      uint64 a = (uint64) sbrk(4096);
    ...
    5216:	a8650513          	add	a0,a0,-1402 # 7c98 <malloc+0x2046>
    521a:	00001097          	auipc	ra,0x1
    521e:	980080e7          	jalr	-1664(ra) # 5b9a <printf>
        exit(1);
    5222:	4505                	li	a0,1
    ...
    5230:	a2c50513          	add	a0,a0,-1492 # 7c58 <malloc+0x2006>
    5234:	00001097          	auipc	ra,0x1
    5238:	966080e7          	jalr	-1690(ra) # 5b9a <printf>
    exit(1);
    523c:	4505                	li	a0,1
    ...
    524a:	a3250513          	add	a0,a0,-1486 # 7c78 <malloc+0x2026>
    524e:	00001097          	auipc	ra,0x1
    5252:	94c080e7          	jalr	-1716(ra) # 5b9a <printf>
    exit(1);
    5256:	4505                	li	a0,1
  ...
  while(1){
    ...
    5298:	a2450513          	add	a0,a0,-1500 # 7cb8 <malloc+0x2066>
    529c:	00001097          	auipc	ra,0x1
    52a0:	8fe080e7          	jalr	-1794(ra) # 5b9a <printf>
      exit(1);
    52a4:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    52e8:	9f450513          	add	a0,a0,-1548 # 7cd8 <malloc+0x2086>
    52ec:	00001097          	auipc	ra,0x1
    52f0:	8ae080e7          	jalr	-1874(ra) # 5b9a <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    5318:	9ec50513          	add	a0,a0,-1556 # 7d00 <malloc+0x20ae>
    531c:	00001097          	auipc	ra,0x1
    5320:	87e080e7          	jalr	-1922(ra) # 5b9a <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    533c:	9b050513          	add	a0,a0,-1616 # 7ce8 <malloc+0x2096>
    5340:	00001097          	auipc	ra,0x1
    5344:	85a080e7          	jalr	-1958(ra) # 5b9a <printf>
    exit(1);
    5348:	4505                	li	a0,1
    ...
    5364:	9a850513          	add	a0,a0,-1624 # 7d08 <malloc+0x20b6>
    5368:	00001097          	auipc	ra,0x1
    536c:	832080e7          	jalr	-1998(ra) # 5b9a <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    53ae:	d7678793          	add	a5,a5,-650 # 8120 <malloc+0x24ce>
    53b2:	bd040713          	add	a4,s0,-1072
    53b6:	00003317          	auipc	t1,0x3
    53ba:	15a30313          	add	t1,t1,346 # 8510 <malloc+0x28be>
  ...
  printf("usertests starting\n");
    ...
    53ee:	9de50513          	add	a0,a0,-1570 # 7dc8 <malloc+0x2176>
    53f2:	00000097          	auipc	ra,0x0
    53f6:	7a8080e7          	jalr	1960(ra) # 5b9a <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    5428:	95c50513          	add	a0,a0,-1700 # 7d80 <malloc+0x212e>
    542c:	00000097          	auipc	ra,0x0
    5430:	76e080e7          	jalr	1902(ra) # 5b9a <printf>
    exit(1);
    5434:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    5444:	8d058593          	add	a1,a1,-1840 # 7d10 <malloc+0x20be>
    ...
    545a:	cca78793          	add	a5,a5,-822 # 8120 <malloc+0x24ce>
    545e:	bd040713          	add	a4,s0,-1072
    5462:	00003317          	auipc	t1,0x3
    5466:	0ae30313          	add	t1,t1,174 # 8510 <malloc+0x28be>
    ...
    549a:	94a50513          	add	a0,a0,-1718 # 7de0 <malloc+0x218e>
    549e:	00000097          	auipc	ra,0x0
    54a2:	6fc080e7          	jalr	1788(ra) # 5b9a <printf>
        printf("SOME TESTS FAILED\n");
    54a6:	00003a97          	auipc	s5,0x3
    54aa:	8c2a8a93          	add	s5,s5,-1854 # 7d68 <malloc+0x2116>
        if(continuous != 2)
    54ae:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    54b0:	00003b17          	auipc	s6,0x3
    54b4:	898b0b13          	add	s6,s6,-1896 # 7d48 <malloc+0x20f6>
    54b8:	a0dd                	j	559e <main+0x22c>
  } else if(argc == 2 && strcmp(argv[1], "-C") == 0){
    54ba:	00003597          	auipc	a1,0x3
    54be:	85e58593          	add	a1,a1,-1954 # 7d18 <malloc+0x20c6>
    ...
    54e2:	84250513          	add	a0,a0,-1982 # 7d20 <malloc+0x20ce>
    54e6:	00000097          	auipc	ra,0x0
    54ea:	6b4080e7          	jalr	1716(ra) # 5b9a <printf>
    exit(1);
    54ee:	4505                	li	a0,1
    ...
    550c:	692080e7          	jalr	1682(ra) # 5b9a <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    5554:	81850513          	add	a0,a0,-2024 # 7d68 <malloc+0x2116>
    5558:	00000097          	auipc	ra,0x0
    555c:	642080e7          	jalr	1602(ra) # 5b9a <printf>
    exit(1);
    5560:	4505                	li	a0,1
    ...
    556e:	84650513          	add	a0,a0,-1978 # 7db0 <malloc+0x215e>
    5572:	00000097          	auipc	ra,0x0
    5576:	628080e7          	jalr	1576(ra) # 5b9a <printf>
    exit(0);
    557a:	4501                	li	a0,0
    ...
    558a:	614080e7          	jalr	1556(ra) # 5b9a <printf>
        if(continuous != 2)
...
00000000000058f4 <printint>:
    ...
    593c:	0685                	add	a3,a3,1
    593e:	fec7f0e3          	bgeu	a5,a2,591e <printint+0x2a>
    5942:	00088c63          	beqz	a7,595a <printint+0x66>
    5946:	fd070793          	add	a5,a4,-48
    594a:	00878733          	add	a4,a5,s0
    594e:	02d00793          	li	a5,45
    5952:	fef70823          	sb	a5,-16(a4)
    5956:	0028071b          	addw	a4,a6,2
    595a:	02e05863          	blez	a4,598a <printint+0x96>
    595e:	fc040793          	add	a5,s0,-64
    5962:	00e78933          	add	s2,a5,a4
    5966:	fff78993          	add	s3,a5,-1
    596a:	99ba                	add	s3,s3,a4
    596c:	377d                	addw	a4,a4,-1
    596e:	1702                	sll	a4,a4,0x20
    5970:	9301                	srl	a4,a4,0x20
    5972:	40e989b3          	sub	s3,s3,a4
    5976:	fff94583          	lbu	a1,-1(s2)
    597a:	8526                	mv	a0,s1
    597c:	00000097          	auipc	ra,0x0
    5980:	f56080e7          	jalr	-170(ra) # 58d2 <putc>
    5984:	197d                	add	s2,s2,-1
    5986:	ff3918e3          	bne	s2,s3,5976 <printint+0x82>
    598a:	70e2                	ld	ra,56(sp)
    598c:	7442                	ld	s0,48(sp)
    598e:	74a2                	ld	s1,40(sp)
    5990:	7902                	ld	s2,32(sp)
    5992:	69e2                	ld	s3,24(sp)
    5994:	6121                	add	sp,sp,64
    5996:	8082                	ret
    5998:	40b005bb          	negw	a1,a1
    599c:	4885                	li	a7,1
    599e:	bf85                	j	590e <printint+0x1a>

00000000000059a0 <vprintf>:
    59a0:	715d                	add	sp,sp,-80
    59a2:	e486                	sd	ra,72(sp)
    59a4:	e0a2                	sd	s0,64(sp)
    59a6:	fc26                	sd	s1,56(sp)
    59a8:	f84a                	sd	s2,48(sp)
    59aa:	f44e                	sd	s3,40(sp)
    59ac:	f052                	sd	s4,32(sp)
    59ae:	ec56                	sd	s5,24(sp)
    59b0:	e85a                	sd	s6,16(sp)
    59b2:	e45e                	sd	s7,8(sp)
    59b4:	e062                	sd	s8,0(sp)
    59b6:	0880                	add	s0,sp,80
    59b8:	0005c903          	lbu	s2,0(a1)
    59bc:	18090c63          	beqz	s2,5b54 <vprintf+0x1b4>
    59c0:	8aaa                	mv	s5,a0
    59c2:	8bb2                	mv	s7,a2
    59c4:	00158493          	add	s1,a1,1
    59c8:	4981                	li	s3,0
    59ca:	02500a13          	li	s4,37
    59ce:	4b55                	li	s6,21
    59d0:	a839                	j	59ee <vprintf+0x4e>
    59d2:	85ca                	mv	a1,s2
    59d4:	8556                	mv	a0,s5
    59d6:	00000097          	auipc	ra,0x0
    59da:	efc080e7          	jalr	-260(ra) # 58d2 <putc>
    59de:	a019                	j	59e4 <vprintf+0x44>
    59e0:	01498d63          	beq	s3,s4,59fa <vprintf+0x5a>
    59e4:	0485                	add	s1,s1,1
    59e6:	fff4c903          	lbu	s2,-1(s1)
    59ea:	16090563          	beqz	s2,5b54 <vprintf+0x1b4>
    59ee:	fe0999e3          	bnez	s3,59e0 <vprintf+0x40>
    59f2:	ff4910e3          	bne	s2,s4,59d2 <vprintf+0x32>
    59f6:	89d2                	mv	s3,s4
    59f8:	b7f5                	j	59e4 <vprintf+0x44>
    59fa:	13490263          	beq	s2,s4,5b1e <vprintf+0x17e>
    59fe:	f9d9079b          	addw	a5,s2,-99
    5a02:	0ff7f793          	zext.b	a5,a5
    5a06:	12fb6563          	bltu	s6,a5,5b30 <vprintf+0x190>
    5a0a:	f9d9079b          	addw	a5,s2,-99
    5a0e:	0ff7f713          	zext.b	a4,a5
    5a12:	10eb6f63          	bltu	s6,a4,5b30 <vprintf+0x190>
    5a16:	00271793          	sll	a5,a4,0x2
    5a1a:	00003717          	auipc	a4,0x3
    5a1e:	afe70713          	add	a4,a4,-1282 # 8518 <malloc+0x28c6>
    5a22:	97ba                	add	a5,a5,a4
    5a24:	439c                	lw	a5,0(a5)
    5a26:	97ba                	add	a5,a5,a4
    5a28:	8782                	jr	a5
    5a2a:	008b8913          	add	s2,s7,8
    5a2e:	4685                	li	a3,1
    5a30:	4629                	li	a2,10
    5a32:	000ba583          	lw	a1,0(s7)
    5a36:	8556                	mv	a0,s5
    5a38:	00000097          	auipc	ra,0x0
    5a3c:	ebc080e7          	jalr	-324(ra) # 58f4 <printint>
    5a40:	8bca                	mv	s7,s2
    5a42:	4981                	li	s3,0
    5a44:	b745                	j	59e4 <vprintf+0x44>
    5a46:	008b8913          	add	s2,s7,8
    5a4a:	4681                	li	a3,0
    5a4c:	4629                	li	a2,10
    5a4e:	000ba583          	lw	a1,0(s7)
    5a52:	8556                	mv	a0,s5
    5a54:	00000097          	auipc	ra,0x0
    5a58:	ea0080e7          	jalr	-352(ra) # 58f4 <printint>
    5a5c:	8bca                	mv	s7,s2
    5a5e:	4981                	li	s3,0
    5a60:	b751                	j	59e4 <vprintf+0x44>
    5a62:	008b8913          	add	s2,s7,8
    5a66:	4681                	li	a3,0
    5a68:	4641                	li	a2,16
    5a6a:	000ba583          	lw	a1,0(s7)
    5a6e:	8556                	mv	a0,s5
    5a70:	00000097          	auipc	ra,0x0
    5a74:	e84080e7          	jalr	-380(ra) # 58f4 <printint>
    5a78:	8bca                	mv	s7,s2
    5a7a:	4981                	li	s3,0
    5a7c:	b7a5                	j	59e4 <vprintf+0x44>
    5a7e:	008b8c13          	add	s8,s7,8
    5a82:	000bb983          	ld	s3,0(s7)
    5a86:	03000593          	li	a1,48
    5a8a:	8556                	mv	a0,s5
    5a8c:	00000097          	auipc	ra,0x0
    5a90:	e46080e7          	jalr	-442(ra) # 58d2 <putc>
    5a94:	07800593          	li	a1,120
    5a98:	8556                	mv	a0,s5
    5a9a:	00000097          	auipc	ra,0x0
    5a9e:	e38080e7          	jalr	-456(ra) # 58d2 <putc>
    5aa2:	4941                	li	s2,16
    5aa4:	00003b97          	auipc	s7,0x3
    5aa8:	accb8b93          	add	s7,s7,-1332 # 8570 <digits>
    5aac:	03c9d793          	srl	a5,s3,0x3c
    5ab0:	97de                	add	a5,a5,s7
    5ab2:	0007c583          	lbu	a1,0(a5)
    5ab6:	8556                	mv	a0,s5
    5ab8:	00000097          	auipc	ra,0x0
    5abc:	e1a080e7          	jalr	-486(ra) # 58d2 <putc>
    5ac0:	0992                	sll	s3,s3,0x4
    5ac2:	397d                	addw	s2,s2,-1
    5ac4:	fe0914e3          	bnez	s2,5aac <vprintf+0x10c>
    5ac8:	8be2                	mv	s7,s8
    5aca:	4981                	li	s3,0
    5acc:	bf21                	j	59e4 <vprintf+0x44>
    5ace:	008b8993          	add	s3,s7,8
    5ad2:	000bb903          	ld	s2,0(s7)
    5ad6:	02090163          	beqz	s2,5af8 <vprintf+0x158>
    5ada:	00094583          	lbu	a1,0(s2)
    5ade:	c9a5                	beqz	a1,5b4e <vprintf+0x1ae>
    5ae0:	8556                	mv	a0,s5
    5ae2:	00000097          	auipc	ra,0x0
    5ae6:	df0080e7          	jalr	-528(ra) # 58d2 <putc>
    5aea:	0905                	add	s2,s2,1
    5aec:	00094583          	lbu	a1,0(s2)
    5af0:	f9e5                	bnez	a1,5ae0 <vprintf+0x140>
    5af2:	8bce                	mv	s7,s3
    5af4:	4981                	li	s3,0
    5af6:	b5fd                	j	59e4 <vprintf+0x44>
    5af8:	00003917          	auipc	s2,0x3
    5afc:	a1890913          	add	s2,s2,-1512 # 8510 <malloc+0x28be>
    5b00:	02800593          	li	a1,40
    5b04:	bff1                	j	5ae0 <vprintf+0x140>
    5b06:	008b8913          	add	s2,s7,8
    5b0a:	000bc583          	lbu	a1,0(s7)
    5b0e:	8556                	mv	a0,s5
    5b10:	00000097          	auipc	ra,0x0
    5b14:	dc2080e7          	jalr	-574(ra) # 58d2 <putc>
    5b18:	8bca                	mv	s7,s2
    5b1a:	4981                	li	s3,0
    5b1c:	b5e1                	j	59e4 <vprintf+0x44>
    5b1e:	02500593          	li	a1,37
    5b22:	8556                	mv	a0,s5
    5b24:	00000097          	auipc	ra,0x0
    5b28:	dae080e7          	jalr	-594(ra) # 58d2 <putc>
    5b2c:	4981                	li	s3,0
    5b2e:	bd5d                	j	59e4 <vprintf+0x44>
    5b30:	02500593          	li	a1,37
    5b34:	8556                	mv	a0,s5
    5b36:	00000097          	auipc	ra,0x0
    5b3a:	d9c080e7          	jalr	-612(ra) # 58d2 <putc>
    5b3e:	85ca                	mv	a1,s2
    5b40:	8556                	mv	a0,s5
    5b42:	00000097          	auipc	ra,0x0
    5b46:	d90080e7          	jalr	-624(ra) # 58d2 <putc>
    5b4a:	4981                	li	s3,0
    5b4c:	bd61                	j	59e4 <vprintf+0x44>
    5b4e:	8bce                	mv	s7,s3
    5b50:	4981                	li	s3,0
    5b52:	bd49                	j	59e4 <vprintf+0x44>
    5b54:	60a6                	ld	ra,72(sp)
    5b56:	6406                	ld	s0,64(sp)
    5b58:	74e2                	ld	s1,56(sp)
    5b5a:	7942                	ld	s2,48(sp)
    5b5c:	79a2                	ld	s3,40(sp)
    5b5e:	7a02                	ld	s4,32(sp)
    5b60:	6ae2                	ld	s5,24(sp)
    5b62:	6b42                	ld	s6,16(sp)
    5b64:	6ba2                	ld	s7,8(sp)
    5b66:	6c02                	ld	s8,0(sp)
    5b68:	6161                	add	sp,sp,80
    5b6a:	8082                	ret

0000000000005b6c <fprintf>:
    5b6c:	715d                	add	sp,sp,-80
    5b6e:	ec06                	sd	ra,24(sp)
    5b70:	e822                	sd	s0,16(sp)
    5b72:	1000                	add	s0,sp,32
    5b74:	e010                	sd	a2,0(s0)
    5b76:	e414                	sd	a3,8(s0)
    5b78:	e818                	sd	a4,16(s0)
    5b7a:	ec1c                	sd	a5,24(s0)
    5b7c:	03043023          	sd	a6,32(s0)
    5b80:	03143423          	sd	a7,40(s0)
    5b84:	fe843423          	sd	s0,-24(s0)
    5b88:	8622                	mv	a2,s0
    5b8a:	00000097          	auipc	ra,0x0
    5b8e:	e16080e7          	jalr	-490(ra) # 59a0 <vprintf>
    5b92:	60e2                	ld	ra,24(sp)
    5b94:	6442                	ld	s0,16(sp)
    5b96:	6161                	add	sp,sp,80
    5b98:	8082                	ret

0000000000005b9a <printf>:
    5b9a:	711d                	add	sp,sp,-96
    5b9c:	ec06                	sd	ra,24(sp)
    5b9e:	e822                	sd	s0,16(sp)
    5ba0:	1000                	add	s0,sp,32
    5ba2:	e40c                	sd	a1,8(s0)
    5ba4:	e810                	sd	a2,16(s0)
    5ba6:	ec14                	sd	a3,24(s0)
    5ba8:	f018                	sd	a4,32(s0)
    5baa:	f41c                	sd	a5,40(s0)
    5bac:	03043823          	sd	a6,48(s0)
    5bb0:	03143c23          	sd	a7,56(s0)
    5bb4:	00840613          	add	a2,s0,8
    5bb8:	fec43423          	sd	a2,-24(s0)
    5bbc:	85aa                	mv	a1,a0
    5bbe:	4505                	li	a0,1
    5bc0:	00000097          	auipc	ra,0x0
    5bc4:	de0080e7          	jalr	-544(ra) # 59a0 <vprintf>
    5bc8:	60e2                	ld	ra,24(sp)
    5bca:	6442                	ld	s0,16(sp)
    5bcc:	6125                	add	sp,sp,96
    5bce:	8082                	ret

0000000000005bd0 <free>:
    5bd0:	1141                	add	sp,sp,-16
    5bd2:	e422                	sd	s0,8(sp)
    5bd4:	0800                	add	s0,sp,16
    5bd6:	ff050693          	add	a3,a0,-16
    5bda:	00003797          	auipc	a5,0x3
    5bde:	9b67b783          	ld	a5,-1610(a5) # 8590 <freep>
    5be2:	a02d                	j	5c0c <free+0x3c>
    5be4:	4618                	lw	a4,8(a2)
    5be6:	9f2d                	addw	a4,a4,a1
    5be8:	fee52c23          	sw	a4,-8(a0)
    5bec:	6398                	ld	a4,0(a5)
    5bee:	6310                	ld	a2,0(a4)
    5bf0:	a83d                	j	5c2e <free+0x5e>
    5bf2:	ff852703          	lw	a4,-8(a0)
    5bf6:	9f31                	addw	a4,a4,a2
    5bf8:	c798                	sw	a4,8(a5)
    5bfa:	ff053683          	ld	a3,-16(a0)
    5bfe:	a091                	j	5c42 <free+0x72>
    5c00:	6398                	ld	a4,0(a5)
    5c02:	00e7e463          	bltu	a5,a4,5c0a <free+0x3a>
    5c06:	00e6ea63          	bltu	a3,a4,5c1a <free+0x4a>
    5c0a:	87ba                	mv	a5,a4
    5c0c:	fed7fae3          	bgeu	a5,a3,5c00 <free+0x30>
    5c10:	6398                	ld	a4,0(a5)
    5c12:	00e6e463          	bltu	a3,a4,5c1a <free+0x4a>
    5c16:	fee7eae3          	bltu	a5,a4,5c0a <free+0x3a>
    5c1a:	ff852583          	lw	a1,-8(a0)
    5c1e:	6390                	ld	a2,0(a5)
    5c20:	02059813          	sll	a6,a1,0x20
    5c24:	01c85713          	srl	a4,a6,0x1c
    5c28:	9736                	add	a4,a4,a3
    5c2a:	fae60de3          	beq	a2,a4,5be4 <free+0x14>
    5c2e:	fec53823          	sd	a2,-16(a0)
    5c32:	4790                	lw	a2,8(a5)
    5c34:	02061593          	sll	a1,a2,0x20
    5c38:	01c5d713          	srl	a4,a1,0x1c
    5c3c:	973e                	add	a4,a4,a5
    5c3e:	fae68ae3          	beq	a3,a4,5bf2 <free+0x22>
    5c42:	e394                	sd	a3,0(a5)
    5c44:	00003717          	auipc	a4,0x3
    5c48:	94f73623          	sd	a5,-1716(a4) # 8590 <freep>
    5c4c:	6422                	ld	s0,8(sp)
    5c4e:	0141                	add	sp,sp,16
    5c50:	8082                	ret

0000000000005c52 <malloc>:
    5c52:	7139                	add	sp,sp,-64
    5c54:	fc06                	sd	ra,56(sp)
    5c56:	f822                	sd	s0,48(sp)
    5c58:	f426                	sd	s1,40(sp)
    5c5a:	f04a                	sd	s2,32(sp)
    5c5c:	ec4e                	sd	s3,24(sp)
    5c5e:	e852                	sd	s4,16(sp)
    5c60:	e456                	sd	s5,8(sp)
    5c62:	e05a                	sd	s6,0(sp)
    5c64:	0080                	add	s0,sp,64
    5c66:	02051493          	sll	s1,a0,0x20
    5c6a:	9081                	srl	s1,s1,0x20
    5c6c:	04bd                	add	s1,s1,15
    5c6e:	8091                	srl	s1,s1,0x4
    5c70:	0014899b          	addw	s3,s1,1
    5c74:	0485                	add	s1,s1,1
    5c76:	00003517          	auipc	a0,0x3
    5c7a:	91a53503          	ld	a0,-1766(a0) # 8590 <freep>
    5c7e:	c515                	beqz	a0,5caa <malloc+0x58>
    5c80:	611c                	ld	a5,0(a0)
    5c82:	4798                	lw	a4,8(a5)
    5c84:	02977f63          	bgeu	a4,s1,5cc2 <malloc+0x70>
    5c88:	8a4e                	mv	s4,s3
    5c8a:	0009871b          	sext.w	a4,s3
    5c8e:	6685                	lui	a3,0x1
    5c90:	00d77363          	bgeu	a4,a3,5c96 <malloc+0x44>
    5c94:	6a05                	lui	s4,0x1
    5c96:	000a0b1b          	sext.w	s6,s4
    5c9a:	004a1a1b          	sllw	s4,s4,0x4
    5c9e:	00003917          	auipc	s2,0x3
    5ca2:	8f290913          	add	s2,s2,-1806 # 8590 <freep>
    5ca6:	5afd                	li	s5,-1
    5ca8:	a895                	j	5d1c <malloc+0xca>
    5caa:	00009797          	auipc	a5,0x9
    5cae:	10678793          	add	a5,a5,262 # edb0 <base>
    5cb2:	00003717          	auipc	a4,0x3
    5cb6:	8cf73f23          	sd	a5,-1826(a4) # 8590 <freep>
    5cba:	e39c                	sd	a5,0(a5)
    5cbc:	0007a423          	sw	zero,8(a5)
    5cc0:	b7e1                	j	5c88 <malloc+0x36>
    5cc2:	02e48c63          	beq	s1,a4,5cfa <malloc+0xa8>
    5cc6:	4137073b          	subw	a4,a4,s3
    5cca:	c798                	sw	a4,8(a5)
    5ccc:	02071693          	sll	a3,a4,0x20
    5cd0:	01c6d713          	srl	a4,a3,0x1c
    5cd4:	97ba                	add	a5,a5,a4
    5cd6:	0137a423          	sw	s3,8(a5)
    5cda:	00003717          	auipc	a4,0x3
    5cde:	8aa73b23          	sd	a0,-1866(a4) # 8590 <freep>
    5ce2:	01078513          	add	a0,a5,16
    5ce6:	70e2                	ld	ra,56(sp)
    5ce8:	7442                	ld	s0,48(sp)
    5cea:	74a2                	ld	s1,40(sp)
    5cec:	7902                	ld	s2,32(sp)
    5cee:	69e2                	ld	s3,24(sp)
    5cf0:	6a42                	ld	s4,16(sp)
    5cf2:	6aa2                	ld	s5,8(sp)
    5cf4:	6b02                	ld	s6,0(sp)
    5cf6:	6121                	add	sp,sp,64
    5cf8:	8082                	ret
    5cfa:	6398                	ld	a4,0(a5)
    5cfc:	e118                	sd	a4,0(a0)
    5cfe:	bff1                	j	5cda <malloc+0x88>
    5d00:	01652423          	sw	s6,8(a0)
    5d04:	0541                	add	a0,a0,16
    5d06:	00000097          	auipc	ra,0x0
    5d0a:	eca080e7          	jalr	-310(ra) # 5bd0 <free>
    5d0e:	00093503          	ld	a0,0(s2)
    5d12:	d971                	beqz	a0,5ce6 <malloc+0x94>
    5d14:	611c                	ld	a5,0(a0)
    5d16:	4798                	lw	a4,8(a5)
    5d18:	fa9775e3          	bgeu	a4,s1,5cc2 <malloc+0x70>
    5d1c:	00093703          	ld	a4,0(s2)
    5d20:	853e                	mv	a0,a5
    5d22:	fef719e3          	bne	a4,a5,5d14 <malloc+0xc2>
    5d26:	8552                	mv	a0,s4
    5d28:	00000097          	auipc	ra,0x0
    5d2c:	b92080e7          	jalr	-1134(ra) # 58ba <sbrk>
    5d30:	fd5518e3          	bne	a0,s5,5d00 <malloc+0xae>
    5d34:	4501                	li	a0,0
    5d36:	bf45                	j	5ce6 <malloc+0x94>
